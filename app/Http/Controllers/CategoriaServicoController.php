...
class CategoriaServicoController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('categoria_servico.show', compact('item'));
    }

    public function create()
    {
        return view('categoria_servico.create', ['formType' => 'create']);
    }
    ...
    public function edit($id)
    {
        ...
        __validaObjetoEmpresa($item);
        $formType = 'edit';
        return view('categoria_servico.edit', compact('item', 'formType'));
    }

...
class ControleAcessoController extends Controller
{
    ...
    public function create(){
        ...
        $formType = 'create';
        return view('controle_acesso.create', compact('permissions', 'formType'));
    }
    ...
    public function store(Request $request)
    {
        $request->merge([
            'type_user' => 2,
            'name' => $request->name."#".$request->empresa_id
        ]);
    ...
    public function edit($id){
        ...
        $formType = 'edit';
        return view('controle_acesso.edit', compact('permissions', 'item', 'formType'));
    }

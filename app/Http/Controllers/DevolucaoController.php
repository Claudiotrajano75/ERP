...
class DevolucaoController extends Controller
{
    ...
    /**
     * Converte CFOP de venda para CFOP de devolução
     * Mapeia o CFOP original para o CFOP correto de devolução conforme regras da SEFAZ
     * 
     * @param string $cfopOriginal CFOP da nota original (extraído do XML)
     * @return string CFOP correto para devolução
     */
    private function convertCfopParaDevolucao($cfopOriginal)
    {
        // Tabela de conversão: CFOP de saída → CFOP de devolução (entrada)
        $mapeamento = [
            // Vendas de mercadoria adquirida de terceiros (revenda)
            '5101' => '1201', // Venda de mercadoria adquirida ou recebida de terceiros
            '5102' => '1202', // Venda de mercadoria adquirida ou recebida de terceiros (com ST)
            '5103' => '1201', // Venda de produção do estabelecimento efetuada fora do estabelecimento
            '5104' => '1201', // Venda de mercadoria adquirida ou recebida de terceiros em operação com mercadoria sujeita ao regime de substituição tributária, na condição de contribuinte substituto
            '5105' => '1202', // Venda de mercadoria adquirida ou recebida de terceiros em operação com mercadoria sujeita ao regime de substituição tributária, na condição de contribuinte substituído
            '5106' => '1201', // Venda de mercadoria adquirida ou recebida de terceiros, que não deva por ele transitar
            '5109' => '1201', // Venda de produção do estabelecimento, quando o produto estiver sujeito ao regime de substituição tributária
            '5110' => '1201', // Venda de mercadoria adquirida ou recebida de terceiros, destinada à Zona Franca de Manaus ou Áreas de Livre Comércio
            '5111' => '1201', // Venda de produção do estabelecimento remetida anteriormente em consignação industrial
            '5112' => '1201', // Venda de mercadoria adquirida ou recebida de terceiros remetida anteriormente em consignação industrial
            '5113' => '1201', // Venda de produção do estabelecimento remetida anteriormente em consignação mercantil
            '5114' => '1201', // Venda de mercadoria adquirida ou recebida de terceiros remetida anteriormente em consignação mercantil
            '5115' => '1201', // Venda de mercadoria adquirida ou recebida de terceiros, recebida anteriormente em consignação mercantil
            '5116' => '1201', // Venda de produção do estabelecimento originada de encomenda para entrega futura
            '5117' => '1201', // Venda de mercadoria adquirida ou recebida de terceiros, originada de encomenda para entrega futura
            '5118' => '1201', // Venda de produção do estabelecimento entregue ao destinatário por conta e ordem do adquirente originário, em venda à ordem
            '5119' => '1201', // Venda de mercadoria adquirida ou recebida de terceiros entregue ao destinatário por conta e ordem do adquirente originário, em venda à ordem
            '5120' => '1201', // Venda de mercadoria adquirida ou recebida de terceiros entregue ao destinatário pelo vendedor remetente, em venda à ordem
            
            // Vendas de produção própria
            '5401' => '1410', // Venda de produção do estabelecimento em operação com produto sujeito ao regime de substituição tributária
            '5402' => '1410', // Venda de produção do estabelecimento de produto sujeito ao regime de substituição tributária, em operação entre contribuintes substitutos do mesmo produto
            '5403' => '1410', // Venda de mercadoria adquirida ou recebida de terceiros em operação com mercadoria sujeita ao regime de substituição tributária, na condição de contribuinte substituto
            '5405' => '1411', // Venda de produção do estabelecimento que não deva por ele transitar
            '5408' => '1410', // Transferência de produção do estabelecimento em operação com produto sujeito ao regime de substituição tributária
            
            // Fora do estado - Mercadoria de terceiros
            '6101' => '2201', // Venda de mercadoria adquirida ou recebida de terceiros
            '6102' => '2202', // Venda de mercadoria adquirida ou recebida de terceiros (com ST)
            '6103' => '2201', // Venda de produção do estabelecimento efetuada fora do estabelecimento
            '6104' => '2201', // Venda de mercadoria adquirida ou recebida de terceiros em operação com mercadoria sujeita ao regime de substituição tributária
            '6105' => '2202', // Venda de mercadoria adquirida ou recebida de terceiros em operação com mercadoria sujeita ao regime de substituição tributária, na condição de contribuinte substituído
            '6106' => '2201', // Venda de mercadoria adquirida ou recebida de terceiros, que não deva por ele transitar
            '6107' => '2201', // Venda de produção do estabelecimento, destinada a não contribuinte
            '6108' => '2201', // Venda de mercadoria adquirida ou recebida de terceiros, destinada a não contribuinte
            '6109' => '2201', // Venda de produção do estabelecimento, quando o produto estiver sujeito ao regime de substituição tributária
            '6110' => '2201', // Venda de mercadoria adquirida ou recebida de terceiros, destinada à Zona Franca de Manaus ou Áreas de Livre Comércio
            '6111' => '2201', // Venda de produção do estabelecimento remetida anteriormente em consignação industrial
            '6112' => '2201', // Venda de mercadoria adquirida ou recebida de terceiros remetida anteriormente em consignação industrial
            '6113' => '2201', // Venda de produção do estabelecimento remetida anteriormente em consignação mercantil
            '6114' => '2201', // Venda de mercadoria adquirida ou recebida de terceiros remetida anteriormente em consignação mercantil
            '6115' => '2201', // Venda de mercadoria adquirida ou recebida de terceiros, recebida anteriormente em consignação mercantil
            '6116' => '2201', // Venda de produção do estabelecimento originada de encomenda para entrega futura
            '6117' => '2201', // Venda de mercadoria adquirida ou recebida de terceiros, originada de encomenda para entrega futura
            '6118' => '2201', // Venda de produção do estabelecimento entregue ao destinatário por conta e ordem do adquirente originário, em venda à ordem
            '6119' => '2201', // Venda de mercadoria adquirida ou recebida de terceiros entregue ao destinatário por conta e ordem do adquirente originário, em venda à ordem
            '6120' => '2201', // Venda de mercadoria adquirida ou recebida de terceiros entregue ao destinatário pelo vendedor remetente, em venda à ordem
            
            // Fora do estado - Produção própria
            '6401' => '2410', // Venda de produção do estabelecimento em operação com produto sujeito ao regime de substituição tributária
            '6402' => '2410', // Venda de produção do estabelecimento de produto sujeito ao regime de substituição tributária, em operação entre contribuintes substitutos do mesmo produto
            '6403' => '2410', // Venda de mercadoria adquirida ou recebida de terceiros em operação com mercadoria sujeita ao regime de substituição tributária, na condição de contribuinte substituto
            '6404' => '2410', // Venda de mercadoria sujeita ao regime de substituição tributária, cujo imposto já tenha sido retido anteriormente
            '6408' => '2410', // Transferência de produção do estabelecimento em operação com produto sujeito ao regime de substituição tributária
            '6409' => '2410', // Transferência de mercadoria adquirida ou recebida de terceiros em operação com mercadoria sujeita ao regime de substituição tributária
        ];
        
        // Busca o CFOP de devolução correspondente
        if (isset($mapeamento[$cfopOriginal])) {
            return $mapeamento[$cfopOriginal];
        }
        
        // Fallback: se não encontrar mapeamento específico, usa lógica genérica
        // Converte 5xxx → 1xxx ou 6xxx → 2xxx, mantendo os 3 últimos dígitos
        $primeiroDigito = substr($cfopOriginal, 0, 1);
        $resto = substr($cfopOriginal, 1);
        
        if ($primeiroDigito == '5') {
            return '1' . $resto; // Dentro do estado
        } elseif ($primeiroDigito == '6') {
            return '2' . $resto; // Fora do estado
        }
        
        // Se não conseguir converter, retorna o original (não deve acontecer)
        return $cfopOriginal;
    }
    ...
    public function finishXml(Request $request)
    {
        try {
            ...
            $nfe = DB::transaction(function () use ($request) {
                ...
                // Obter UF da empresa e do fornecedor para conversão de CFOP
                $fornecedor = Fornecedor::with('cidade')->find($fornecedor_id);
                $empresaComCidade = Empresa::with('cidade')->find($request->empresa_id);
                $ufEmpresa = $empresaComCidade->cidade->uf ?? '';
                $ufFornecedor = $fornecedor->cidade->uf ?? '';
                ...
                $request->merge([
                    ...
                    'finNFe' => 4, // 4 = Devolução de mercadoria
                    'tpNF' => 0 // 0 = Entrada (devolução é sempre entrada para quem recebe)
                ]);
                ...
                for ($i = 0; $i < sizeof($request->produto_id); $i++) {
                    ...
                    // Converter CFOP original para CFOP de devolução
                    $cfopOriginal = $request->cfop[$i];
                    $cfopDevolucao = $this->convertCfopParaDevolucao($cfopOriginal);
                    ...
                    ItemNfe::create([
                        ...
                        'cfop' => $cfopDevolucao, // Usar CFOP convertido automaticamente
                        'ncm' => $request->ncm[$i],
...
public function update(Request $request, $id)
{
    ...
    try {
        ...
        $nfe = DB::transaction(function () use ($request, $nfe) {
            ...
            // Obter UF da empresa e do fornecedor para conversão de CFOP
            $fornecedor = Fornecedor::with('cidade')->find($nfe->fornecedor_id);
            $empresaComCidade = Empresa::with('cidade')->find($nfe->empresa_id);
            $ufEmpresa = $empresaComCidade->cidade->uf ?? '';
            $ufFornecedor = $fornecedor->cidade->uf ?? '';

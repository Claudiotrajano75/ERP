...
class OrdemServicoController extends Controller
{
    ...
    public function create()
    {
        ...
        $formType = 'create';
        return view('ordem_servico.create', compact('hoje', 'funcionario', 'usuario', 'servicos', 'formType'));
    }
    ...
    public function edit($id)
    {
        ...
        $formType = 'edit';
        return view('ordem_servico.edit', compact('funcionario', 'usuario', 'servicos', 'item', 'formType'));
    }

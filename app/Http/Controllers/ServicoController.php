...
class ServicoController extends Controller
{
    ...
    public function show($id)
    {
        ...
        return view('servicos.show', compact('item'));
    }
    ...
    public function create(Request $request)
    {
        ...
        $formType = 'create';
        return view('servicos.create', compact('categorias', 'marketplace', 'formType'));
    }
    ...
    public function edit($id)
    {
        ...
        $categorias = CategoriaServico::where('empresa_id', request()->empresa_id)->get();
        $formType = 'edit';
        return view('servicos.edit', compact('item', 'categorias', 'formType'));
    }

...
class Produto extends Model
{
	...
	protected $fillable = [
		...
		'perc_cofins', 'perc_ipi', 'perc_ibs', 'perc_cbs', 'cst_csosn', 'cst_pis', 'cst_cofins', 'cst_ipi', 'valor_unitario',
		...
		'balanca_pdv', 'mercado_livre_modelo', 'valor_minimo_venda', 'exportar_balanca'
	];

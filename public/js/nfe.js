...
// $(".next").keypress(function(e){
    ...
    $(document).on("change", ".produto_id", function () {
        ...
        if (product_id) {
            ...
            $perc_ibs = $perc_ipi.closest('td').next().find('input');
            $perc_cbs = $perc_ibs.closest('td').next().find('input');
            $perc_red_bc = $perc_cbs.closest('td').next().find('input');
            ...
            $perc_ibs.val(e.perc_ibs)
            $perc_cbs.val(e.perc_cbs)

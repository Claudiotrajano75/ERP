                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            ...
                            <p class="mb-0 modulo-subtitle fs-13">
                                Gerencie quartos, suítes e outras acomodações.
                            </p>
                        </div>
                        @can('acomodacao_create')
                        <a href="{{ route('acomodacao.create') }}" class="btn btn-success fw-semibold px-4 py-2">
                            <i class="ri-add-circle-fill me-1"></i> Nova Acomodação
                        </a>
                        @endcan
                    </div>
                </div>
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="row g-2 align-items-end">
                                ...
                                <div class="col-md-auto">
                                    ...
                                    <a id="clear-filter" class="btn btn-danger" href="{{ route('acomodacao.index') }}"><i class="ri-eraser-fill me-1"></i>Limpar</a>
                                </div>
                            </div>
                            {!!Form::close()!!}
                        </div>
                        ...
                        <table class="table table-custom mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('acomodacao.destroy', $item->id) }}" method="post" id="form-{{$item->id}}" class="d-flex gap-1 flex-wrap">
                                            @method('delete')
                                            @can('acomodacao_edit')
                                            <a class="btn btn-warning btn-sm text-white" href="{{ route('acomodacao.edit', [$item->id]) }}" data-bs-toggle="tooltip" title="Editar">
                                ...
                                <tr>
                                    <td colspan="6" class="text-center py-5">
                                        <i class="ri-hotel-line fs-1 text-muted opacity-50 mb-3 d-block"></i>
                                        <h5 class="text-muted">Nenhuma acomodação encontrada</h5>
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>

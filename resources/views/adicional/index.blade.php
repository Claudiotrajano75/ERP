                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        ...
                        <p class="text-muted mb-0 modulo-subtitle fs-13">
                            Gerencie os itens adicionais que podem ser vinculados aos produtos do cardápio.
                        </p>
                    </div>
                    <div>
                        <a href="{{ route('adicionais.create') }}" class="btn btn-light btn-sm px-3 text-dark">
                            <i class="ri-add-circle-line align-middle me-1"></i> Novo Adicional
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body p-4">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div class="flex-grow-1 overflow-hidden">
                                        ...
                                        <p class="mb-0 text-white-50 fs-11">Adicionais cadastrados</p>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div class="flex-grow-1 overflow-hidden">
                                        ...
                                        <p class="mb-0 text-white-50 fs-11">Disponíveis para venda</p>
                                    </div>
                                    <div class="avatar-sm flex-shrink-0">
                                        <span class="avatar-title bg-white bg-opacity-25 text-white rounded rounded-3 fs-3 widget-icon-box-avatar shadow">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div class="flex-grow-1 overflow-hidden">
                                        ...
                                        <p class="mb-0 text-white-50 fs-11">Indisponíveis</p>
                                    </div>
                                    <div class="avatar-sm flex-shrink-0">
                                        <span class="avatar-title bg-white bg-opacity-25 text-white rounded rounded-3 fs-3 widget-icon-box-avatar shadow">
                ...
                <div class="modulo-glass-filter p-3 mb-4">
                    ...
                    <div class="row g-2 align-items-end">
                        ...
                        <div class="col-md-3 col-6">
                            <a class="btn btn-danger btn-sm w-100" href="{{ route('adicionais.index') }}">
                        ...
                        <table class="table table-centered table-hover align-middle mb-0 text-dark">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="fw-bold">{{ __moeda($item->valor) }}</td>
                                    ...
                                    <td class="text-end">
                                        <form action="{{ route('adicionais.destroy', $item->id) }}" method="post" id="form-{{$item->id}}" class="m-0">
                                            @method('delete')
                                            @csrf
                                            <div class="modulo-action-group">
                                                <a class="btn btn-warning btn-sm text-white" href="{{ route('adicionais.edit', [$item->id]) }}" title="Editar">
                ...
                <div class="modulo-footer">
                    <div class="text-muted fs-13">
                        Total: <strong>{{ $data->total() }}</strong> {{ $data->total() == 1 ? 'adicional' : 'adicionais' }}
                    </div>
                    <div>

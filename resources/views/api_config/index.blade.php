                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            <h4 class="mb-1 modulo-title d-flex align-items-center gap-2">
                                ...
                                Tokens e Integração API
                            </h4>
                            <p class="text-muted mb-0 modulo-subtitle fs-13">
                                Gerencie as chaves de acesso (Bearer Tokens), escopos de permissões e monitore as requisições à API.
                            </p>
                        </div>
                        <div class="d-flex align-items-center gap-2">
                            <a href="{{ route('config-api.logs') }}" class="dash-btn dash-btn-light">
                                <i class="ri-survey-line"></i> Logs de Acesso
                            </a>
                            <a href="{{ route('config-api.create') }}" class="dash-btn dash-btn-primary">
                                <i class="ri-add-circle-line"></i> Novo Token
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-md-3 col-6">
                            <div class="stat-card stat-indigo">
                                ...
                                <div class="stat-icon"><i class="ri-key-2-line"></i></div>
                            </div>
                        </div>
                        <div class="col-md-3 col-6">
                        ...
                        <div class="col-md-3 col-6">
                            <div class="stat-card stat-amber">
                                <div>
                                    ...
                                    <div class="stat-value mt-1">{{ $stats['total_logs'] }}</div>
                                </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <span class="modulo-badge modulo-badge-inactive">
                                                    <i class="ri-close-circle-line"></i> Desativado
                                                </span>
                                            @endif
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-end">
                                            <form action="{{ route('config-api.destroy', $item->id) }}" method="post" id="form-{{$item->id}}" class="m-0">
                                                ...
                                                @csrf
                                                <div class="act-group">
                                                    <a class="act-btn act-edit" href="{{ route('config-api.edit', [$item->id]) }}" title="Editar Token & Permissões">
                                                        <i class="ri-pencil-line"></i>
                                                    </a>
                                                    <button type="button" class="act-btn act-del btn-delete" title="Excluir Token">
                                    ...
                                    <tr>
                                        <td colspan="4">
                                            <div class="modulo-empty">
                                                <i class="ri-key-line"></i>
                                                <p>Nenhum token de API cadastrado até o momento.</p>
                                            </div>
                                        </td>
                                    </tr>
                                    @endforelse

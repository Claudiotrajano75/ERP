@extends('layouts.app', ['title' => 'Nova Apuração'])
                ...
                <div class="card-header modulo-header-gradient py-3 px-4">
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            ...
                            <p class="text-muted mb-0 modulo-subtitle fs-13">Gere a soma e subtração de proventos de holerite para consolidação de pagamento do colaborador.</p>
                        </div>
                        <div>

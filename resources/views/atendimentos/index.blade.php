@extends('layouts.app', ['title' => 'Dias de Atendimento'])
            ...
            <div class="card-header modulo-header-gradient py-3 px-4">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        ...
                        <p class="text-muted mb-0 modulo-subtitle fs-13">Configure a escala semanal e disponibilidade de atendimento de cada colaborador.</p>
                    </div>
                    <div class="d-flex gap-2 flex-wrap">
                        ...
                        <a href="{{ route('atendimentos.create') }}" class="dash-btn dash-btn-primary">
                            <i class="ri-add-line"></i> Novo Vínculo
                        </a>
                        @endcan
                    </div>
                </div>
            ...
            <div class="card-body p-4">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-12 col-md-4">
                        <div class="stat-card stat-indigo">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    <div class="st-label">Escalas Cadastradas</div>
                                    <div class="st-value">{{ $stats['total'] ?? count($data) }}</div>
                                    <div class="st-sub">vínculos de atendimento</div>
                                </div>
                        ...
                        <div class="stat-card stat-green">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <div class="st-value">{{ $stats['total_funcionarios'] ?? count($funcionarios) }}</div>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="stat-card stat-amber">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    <div class="st-label">Sem Escala Definida</div>
                                    <div class="st-value">{{ $stats['funcionarios_sem_escala'] ?? 0 }}</div>
                                    <div class="st-sub">pendentes de configuração</div>
                                </div>
                    ...
                    <form method="get" action="{{ route('atendimentos.index') }}">
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-3 col-12 d-flex gap-2">
                                ...
                                <a class="dash-btn dash-btn-light px-3" href="{{ route('atendimentos.index') }}" title="Limpar Filtros">
                ...
                <div class="tb-wrap">
                    <div class="table-responsive">
                        <table class="table table-centered table-hover align-middle mb-0">
                            <thead>
                                <tr>
                                    <th>Colaborador / Profissional</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="pill pill-role">
                                            <i class="ri-calendar-check-line"></i> {{ $item->diaStr() }}
                                        </span>
                                    </td>
                                    <td class="text-end">
                                        <form action="{{ route('atendimentos.destroy', $item->id) }}" method="post" id="form-{{$item->id}}" class="m-0">
                                            @method('delete')
                                            @csrf
                                            <div class="act-group">
                                                @can('atendimentos_edit')
                                                <a class="act-btn act-edit" href="{{ route('atendimentos.edit', [$item->id]) }}" title="Editar"><i class="ri-pencil-line"></i></a>
                                                @endcan
                                ...
                                <tr>
                                    <td colspan="3">
                                        <div class="empty-state">
                                            ...
                                            <p>Nenhum vínculo de atendimento cadastrado.</p>
                                        </div>
                                    </td>
                                </tr>
                                @endforelse
                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mt-3">
                    <div class="fs-12" style="color:#94a3b8;">
                        Exibindo <strong>{{ count($data) }}</strong> {{ count($data) == 1 ? 'vínculo' : 'vínculos' }} de atendimento
                    </div>
                </div>

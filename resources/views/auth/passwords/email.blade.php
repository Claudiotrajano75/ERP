...
<head>
    ...
    <title>Recuperar Senha — ERP Gestão Empresarial</title>
        ...
        <div class="left-banner">
            ...
            <div class="banner-content">
                ...
                <p class="banner-description">
                    Recupere o acesso à sua conta corporativa com total segurança e rapidez. 
            ...
            <div class="form-container">
                ...
                <form method="POST" action="{{ route('password.email') }}" id="form-reset-email">
                    ...
                    <div class="form-group">
                        <label for="email" class="form-label">E-mail corporativo cadastrado</label>
                        <div class="input-box">
                    ...
                    <button type="submit" class="btn-auth" id="btn-submit">
                        ...
                        <span id="btn-text">ENVIAR LINK DE REDEFINIÇÃO</span>
                    </button>

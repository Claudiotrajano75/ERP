...
<head>
    ...
    <title>Criar Nova Senha — ERP Gestão Empresarial</title>
        ...
        <div class="left-banner">
            ...
            <div class="banner-content">
                <h1 class="banner-title">
                    Criar Nova Senha<br>
                    <span>Segura & Protegida</span>
                </h1>
                
                <p class="banner-description">
                    Defina sua nova senha de acesso ao sistema de gestão empresarial. 
                    Mantenha suas credenciais seguras para proteger os dados da sua empresa.
                </p>
        ...
        <div class="right-form-panel">
            ...
            <div class="form-container">
                ...
                <div class="brand-header">
                    ...
                    <p class="auth-subtitle">Escolha uma nova senha segura para a sua conta.</p>
                </div>
                ...
                <form method="POST" action="{{ route('password.update') }}" id="form-reset-password">
                    ...
                    <p class="auth-footer-nav">
                        Voltar para o <a href="{{ route('login') }}" class="auth-link">Login</a>
                    </p>

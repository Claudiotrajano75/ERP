                            ...
                            <div class="col-sm-6 col-md-4 col-lg">
                                <div class="d-flex align-items-center">
                                    <div class="avatar-sm bg-light rounded p-2 me-2 text-center" style="width: 40px; height: 40px; display: flex; align-items: center; justify-content: center;">
                                        <i class="ri-map-pin-line fs-20 text-muted"></i>
                                    </div>
                                    <div>
                                        <small class="text-muted d-block">Localização</small>
                                        <span class="fw-medium text-danger">{{ $item->localizacao ? $item->localizacao->descricao : '' }}</span>
                                    </div>
                                </div>
                            </div>
                            @endif
                        ...
                        <div class="card shadow-none border border-start border-3 border-success h-100 mb-0">
                            <div class="card-body p-3">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <p class="text-muted mb-1 text-uppercase fs-12 fw-bold">Saldo em Caixa</p>

            ...
            <div class="card border-0 shadow-sm modulo-form-card">
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            <h4 class="mb-1 modulo-title d-flex align-items-center gap-2">
                                ...
                                Ingredientes para {{ $item->nome }}
                            </h4>
                            <p class="text-muted mb-0 modulo-subtitle fs-13">
                                Gerencie os ingredientes que compõem este produto do cardápio.
                            </p>
                        </div>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="modulo-glass-filter p-3 mb-4">
                        {!!Form::open()->post()->route('produtos-cardapio.store-ingrediente')!!}
                        <div class="row g-2 align-items-end">
                            <div class="col-md-6 col-12">
                                {!!Form::text('ingrediente', 'Nome do Ingrediente')->required()
                                ->attrs(['class' => 'form-control', 'placeholder' => 'Ex: Queijo mussarela'])
                                !!}
                            </div>
                    ...
                    <h5 class="text-dark border-bottom pb-2 mb-3">
                        <i class="ri-list-check text-primary me-2 align-middle fs-18"></i>
                    ...
                    <div class="modulo-table-wrap">
                        <div class="table-responsive">
                            <table class="table table-centered table-hover align-middle mb-0 text-dark">
                                ...
                                <tbody>
                                    @forelse($item->ingredientes as $a)
                                    <tr>
                                        <td class="fw-semibold text-dark">{{ $a->ingrediente }}</td>
                                        <td class="text-end">
                                            <form action="{{ route('produtos-cardapio.destroy-ingrediente', $a->id) }}" method="post" id="form-{{$a->id}}" class="m-0">
                                                @method('delete')
                                                @csrf

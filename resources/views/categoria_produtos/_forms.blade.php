<div class="row g-3 text-dark">
    ...
    <div class="col-12">
        <h5 class="text-dark border-bottom pb-2 mb-3"><i class="ri-information-line text-primary me-2 align-middle fs-18"></i> 1. Informações Básicas</h5>
        <div class="row g-3">
            @if(__isInternacionalizar(Auth::user()->empresa))
                ...
                <div class="col-md-6 col-12">
                    ...
                    !!}
                    <div class="form-text text-muted fs-11 mt-1">Preencha apenas se esta for uma subcategoria de outro item.</div>
                </div>
            @else
                <div class="col-md-6 col-12">
    ...
    <div class="col-12 mt-4">
        <h5 class="text-dark border-bottom pb-2 mb-3"><i class="ri-global-line text-primary me-2 align-middle fs-18"></i> 2. Canais de Venda & Integrações</h5>
        <div class="row g-3">

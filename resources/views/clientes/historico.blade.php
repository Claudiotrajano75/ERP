                ...
                <div class="card-body p-4">
                    <div id="basicwizard">
                        <ul class="nav nav-pills nav-justified mb-4 border p-1 rounded bg-light" role="tablist">
                            <li class="nav-item">
                                <a href="#tab-vendas" data-bs-toggle="tab" class="nav-link rounded py-2 active" role="tab">
                                    <i class="ri-shopping-bag-line me-1 align-middle fs-16"></i> Vendas Efetuadas
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="#tab-produtos" data-bs-toggle="tab" class="nav-link rounded py-2" role="tab">
                                    <i class="ri-box-3-line me-1 align-middle fs-16"></i> Produtos Adquiridos
                                </a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content border p-3 rounded bg-white shadow-sm mt-3">
                            <!-- original tab content preserved -->
                            <div class="tab-pane show active" id="tab-vendas" role="tabpanel">
                                    ...
                                    <table class="table table-centered table-hover align-middle mb-0 text-dark">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    @else
                                                    <span class="badge bg-light text-dark border px-2 py-1 fs-11">Novo</span>
                                                    @endif
                                                </td>
                                                <td class="text-muted fs-12">{{ $c->estado == 'aprovado' ? $c->chave : '--' }}</td>
                                                <td class="fw-semibold">{{ $c->estado == 'aprovado' ? $c->numero : '--' }}</td>
                                                <td><span class="badge bg-light text-dark border">{{ $c->tipo == 'nfce' ? 'PDV NFC-e' : 'NF-e' }}</span></td>
                                            </tr>
                                            @php $total += $c->total; @endphp
                                            @empty
                                            <tr><td colspan="6" class="text-center text-muted py-3">Nenhuma venda encontrada.</td></tr>
                                            @endforelse
                                        </tbody>
                                        @if(sizeof($data) > 0)
                                        <tfoot class="table-light">
                                            <tr class="fw-bold">
                                                ...
                                                <td class="text-success fs-15" colspan="5">R$ {{ __moeda($total) }}</td>
                                            </tr>
                                        </tfoot>
                                        @endif
                                    </table>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-centered table-hover align-middle mb-0 text-dark">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><img class="rounded border bg-light" src="{{ $p->produto->img }}" alt="{{ $p->produto->nome }}" style="width: 38px; height: 38px; object-fit: cover;"></td>
                                            ...
                                            @empty
                                            <tr><td colspan="5" class="text-center text-muted py-3">Nenhum produto adquirido.</td></tr>
                                            @endforelse
                                        </tbody>
                                    </table>
                                </div>
                                    ...
                                    <table class="table table-centered table-hover align-middle mb-0 text-dark">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @if($c->status)
                                                    <span class="badge bg-success-subtle text-success border border-success-subtle px-2 py-1 fs-11"><i class="ri-checkbox-circle-line me-1 align-middle"></i>Recebido</span>
                                                    @else
                                                    <span class="badge bg-warning-subtle text-warning border border-warning-subtle px-2 py-1 fs-11"><i class="ri-alert-line me-1 align-middle"></i>Pendente</span>
                                                    @endif
                                                </td>
                                            </tr>
                                            @empty
                                            <tr><td colspan="6" class="text-center text-muted py-3">Nenhuma fatura emitida.</td></tr>
                                            @endforelse
                                        </tbody>
                                    </table>
                                </div>

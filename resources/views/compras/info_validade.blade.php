                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            <h4 class="mb-1 modulo-title d-flex align-items-center gap-2">
                                ...
                                Controlar Lotes e Vencimentos
                            </h4>
                            <p class="text-muted mb-0 modulo-subtitle fs-13">Preencha as informações de validade e número de lote para os produtos da compra: <strong class="text-white">#{{ $compra->id }}</strong>.</p>
                        </div>
                        <div>
                            ...
                            <table class="table table-centered table-hover align-middle mb-0 text-dark">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 300px;">Número do Lote</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <input class="form-control bg-light border-0 fw-semibold text-dark" readonly type="text" name="produto_nome[]" value="{{ $item->produto->nome }}">
                                        </td>
                                        <td>
                                            <input type="text" name="lote[]" required class="form-control" data-mask="AAAAAAAAAAAAAAAAAAAAAAAA" value="{{ isset($item) ? $item->lote : '' }}" placeholder="Insira o lote">
                                        </td>
                                        <td>
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="3" class="text-center text-muted py-3">Nenhum produto com necessidade de rastreio de validade.</td>
                                    </tr>
                                    @endforelse
                                </tbody>
                            </table>
                    ...
                    <div class="col-12">
                        <div class="modulo-actions">
                            <div class="d-flex align-items-center justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn btn-success px-4" id="btn-save-validade">
                                    <i class="ri-save-line align-middle me-1"></i> Salvar Lotes
                                </button>
                            </div>
                        </div>
                    </div>

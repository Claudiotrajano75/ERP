                ...
                <div class="card-header modulo-header-gradient py-3 px-4">
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            ...
                            <p class="text-muted mb-0 modulo-subtitle fs-13">Defina códigos de identificação única (número de série/patrimônio) e observações por unidade comprada.</p>
                        </div>
                        <div>
                            ...
                            <table class="table table-centered table-hover align-middle mb-0 text-dark">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 250px;">Código Único / Série</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" name="codigo[]" required class="form-control" placeholder="Insira o código">
                                        </td>
                                        <td>
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="3" class="text-center text-muted py-3">Nenhum produto cadastrado nesta nota de compra.</td>
                                    </tr>
                                    @endforelse
                                </tbody>
                            </table>
                    ...
                    <div class="col-12">
                        <div class="modulo-actions">
                            <div class="d-flex align-items-center justify-content-end gap-2">
                                ...
                                <button type="submit" class="btn btn-success px-4" id="btn-save-codigos">
                                    <i class="ri-save-line align-middle me-1"></i> Salvar Códigos
                                </button>
                            </div>
                        </div>
                    </div>

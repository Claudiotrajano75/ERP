                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            <h4 class="mb-1 modulo-title d-flex align-items-center gap-2">
                                ...
                                Importação de XML de Compra (NFe Entrada)
                            </h4>
                            <p class="text-muted mb-0 modulo-subtitle fs-13">Escolha o arquivo XML da nota fiscal emitida pelo fornecedor para dar entrada nos estoques automaticamente.</p>
                        </div>
                        <div>
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-6 col-12">
                            <label for="inp-file" class="custom-file-upload mb-3">
                                ...
                                <span class="text-muted fs-12 mt-1">Formatos aceitos: arquivos no formato .xml</span>
                            </label>
                            
                            {!! Form::file('file', 'XML')
                            ->attrs(['accept' => '.xml', 'id' => 'inp-file']) !!}

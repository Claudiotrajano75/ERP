<div class="row g-3">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <div class="input-group flex-nowrap">
                    <select id="inp-fornecedor_id" name="fornecedor_id" class="form-select select2 fornecedor_id">
                        @if(isset($item) && $item->fornecedor)
                        <option value="{{ $item->fornecedor_id }}">{{ $item->fornecedor->razao_social }}</option>
                        @endif
                    </select>
                    @can('fornecedores_create')
                    <button class="btn btn-dark" data-bs-toggle="modal" data-bs-target="#modal_novo_fornecedor" type="button" title="Novo Fornecedor">
    ...
    <div class="col-md-4">
        {!!Form::select('status', 'Conta Paga', ['0' => 'Não (Pendente)', '1' => 'Sim (Paga)'])
    ...
    <div class="col-md-12">
        <div class="form-group">
            {!! Form::file('file', 'Anexo de Comprovante ou Fatura (PDF ou Imagem)')
    ...
    <div class="col-12 mt-1">
        <div class="alert alert-info border-0 bg-info-subtle text-info d-flex align-items-center mb-0 py-2">
            ...
            <div>
                ...
                <a href="{{ route('conta-pagar.download-file', [$item->id]) }}" class="fw-bold text-info text-decoration-underline ms-1">
    ...
    <div class="col-12 mt-4">
        ...
        <div class="d-flex align-items-center justify-content-end gap-2">
            <a href="{{ route('conta-pagar.index') }}" class="btn btn-light px-4">Cancelar</a>

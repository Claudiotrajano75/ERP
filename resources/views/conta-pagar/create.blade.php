@extends('layouts.app', ['title' => 'Nova Conta a Pagar'])
                ...
                <div class="card-header modulo-header-gradient py-3 px-4">
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            ...
                            <p class="text-muted mb-0 modulo-subtitle fs-13">Preencha os campos abaixo para registrar uma nova despesa ou conta a pagar.</p>
                        </div>
                        <div>

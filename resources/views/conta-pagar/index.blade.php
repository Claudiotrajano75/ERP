                ...
                <div class="modulo-glass-filter p-3 mb-4">
                    ...
                    <div class="row g-2 align-items-end">
                        <div class="col-md-3 col-12">
                            {!!Form::select('fornecedor_id', 'Fornecedor')->attrs(['class' => 'select2 form-select form-select-sm'])
                        ...
                        <div class="col-md-2 col-6">
                            {!!Form::select('status', 'Status', ['' => 'Todas', 1 => 'Pagas', 0 => 'Pendentes'])->attrs(['class' => 'form-select form-select-sm'])!!}
                        </div>
                        <div class="col-md-1 col-6">
                            {!!Form::select('ordem', 'Ordenar', ['' => 'Cadastro', 1 => 'Vencimento'])->attrs(['class' => 'form-select form-select-sm'])!!}
                        </div>
                        ...
                        <div class="col-md-2 col-12 ms-auto">
                            <div class="d-flex gap-2">
                                ...
                                <a class="btn btn-outline-secondary btn-sm px-3" href="{{ route('conta-pagar.index') }}"><i class="ri-eraser-line me-1"></i> Limpar</a>
                            </div>
                        </div>
                    </div>
                    {!!Form::close()!!}

                ...
                <div class="modulo-glass-filter-premium">
                    <div class="filtro-premium-header">
                        <h5 class="filtro-premium-title">
                            <i class="ri-search-line"></i> Filtrar Contas a Pagar
                        </h5>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-3 col-12">
                            ...
                            ->options((isset($fornecedor) && $fornecedor != null) ? [$fornecedor->id => $fornecedor->info] : [])!!}
                        </div>
                        ...
                        <div class="col-md-2 col-12 ms-auto d-flex align-items-end">
                            <div class="d-flex gap-2 w-100">
                                ...
                                <a class="btn btn-limpar px-3" href="{{ route('conta-pagar.index') }}" title="Limpar Filtros">

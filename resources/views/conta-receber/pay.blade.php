                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            <h4 class="mb-1 modulo-title d-flex align-items-center gap-2">
                                ...
                                Registrar Recebimento de Conta #{{ $item->id }}
                            </h4>
                            <p class="text-muted mb-0 modulo-subtitle fs-13">Confira as informações da receita e informe a conta de entrada financeira.</p>
                        </div>
                        <div>
                        ...
                        <div class="card-body p-3">
                            <div class="row g-3">
                                <div class="col-sm-3 col-6">
                                    ...
                                    <p class="fw-semibold text-dark mb-0 fs-13">{{ $item->cliente ? $item->cliente->razao_social : '--' }}</p>
                                </div>
                                <div class="col-sm-3 col-6">
                                ...
                                <div class="col-sm-3 col-6">
                                    ...
                                    <p class="fw-bold text-dark mb-0 fs-14">R$ {{ __moeda($item->valor_integral - $item->valor_recebido) }}</p>
                                </div>
                            </div>
                        </div>
                    </div>

                ...
                <div class="card-header modulo-header-gradient py-3 px-4">
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            ...
                            <p class="text-muted mb-0 modulo-subtitle fs-13">Preencha as informações do recebimento da conta a receber.</p>
                        </div>
                        <div>
                            <a href="{{ route('conta-receber.index') }}" class="btn btn-light btn-sm px-3 text-dark">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="card bg-light-subtle shadow-none border mb-4">
                        <div class="card-body p-3">
                            <div class="row g-3">
                                <div class="col-sm-6">
                                    <h6 class="mb-1 text-muted fs-11 text-uppercase fw-bold">Data de Cadastro</h6>
                                    <p class="fw-semibold text-dark mb-0 fs-13">{{ __data_pt($item->created_at) }}</p>
                                </div>
                                <div class="col-sm-6">
                                    <h6 class="mb-1 text-muted fs-11 text-uppercase fw-bold">Data de Vencimento</h6>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <p class="fw-bold text-success mb-0 fs-14">R$ {{ __moeda($item->valor_integral) }}</p>
                                </div>
                                <div class="col-sm-6">
                                    <h6 class="mb-1 text-muted fs-11 text-uppercase fw-bold">Referência / Documento</h6>
                                    <p class="fw-semibold text-dark mb-0 fs-13">{{ $item->referencia ?? '--' }}</p>
                                </div>
                            </div>
                        </div>
                    </div>

                ...
                <div class="modulo-glass-filter p-3 mb-4">
                    ...
                    <div class="row g-2 align-items-end">
                        <div class="col-md-4 col-12">
                            {!!Form::select('banco', 'Banco', ['' => 'Todos os Bancos'] + \App\Models\ContaBoleto::bancos())->value($banco ? $banco : null)->attrs(['class' => 'form-select form-select-sm'])!!}
                        </div>
                        <div class="col-md-3 col-12 ms-auto">
                            <div class="d-flex gap-2">
                                ...
                                <a class="btn btn-outline-secondary btn-sm px-3" href="{{ route('contas-boleto.index') }}"><i class="ri-eraser-line me-1"></i> Limpar</a>
                            </div>
                        </div>
                    </div>
                    {!!Form::close()!!}

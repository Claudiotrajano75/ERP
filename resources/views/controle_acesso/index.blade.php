        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-header modulo-header-gradient py-3 px-4">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        ...
                        <p class="text-muted mb-0 modulo-subtitle fs-13">Gerencie os papéis de acesso personalizados da sua empresa.</p>
                    </div>
                    <div>
                        @can('controle_acesso_create')
                        <a href="{{ route('controle-acesso.create') }}" class="dash-btn dash-btn-primary">
                            <i class="ri-add-line"></i> Novo Controle
                        </a>
                        @endcan
                    </div>
                </div>
            ...
            <div class="card-body p-4">
                    ...
                    <div class="col-6 col-xl-4">
                        <div class="stat-card stat-indigo">
                            <div class="d-flex justify-content-between align-items-start">
                                <div><div class="st-label">Controles de Acesso</div><div class="st-value">{{ $stats['total'] }}</div><div class="st-sub">papéis da empresa</div></div>
                                <div class="st-icon"><i class="ri-shield-keyhole-line"></i></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-xl-4">
                        <div class="stat-card stat-blue">
                            <div class="d-flex justify-content-between align-items-start">
                                <div><div class="st-label">Permissões</div><div class="st-value">{{ $stats['permissoes'] }}</div><div class="st-sub">disponíveis no sistema</div></div>
                                <div class="st-icon"><i class="ri-lock-2-line"></i></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-6 col-xl-4">
                ...
                <div class="filter-wrap">
                    <div class="filtro-premium-header">
                        <h5 class="filter-title mb-0">
                            <i class="ri-search-line"></i> Filtrar Controles de Acesso
                        </h5>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-8 col-12">
                            <label class="form-label"><i class="ri-shield-keyhole-line"></i> Pesquisar por Descrição</label>
                            {!!Form::text('descricao', '')->attrs(['class' => 'form-control', 'placeholder' => 'Digite a descrição do controle de acesso...'])!!}
                        </div>
                        <div class="col-md-3 col-12 ms-auto d-flex align-items-end">
                            <div class="d-flex gap-2 w-100">
                                ...
                                <a class="btn btn-light border px-3" style="border-radius:10px;" href="{{ route('controle-acesso.index') }}" title="Limpar Filtros">
                    ...
                    <div class="table-responsive">
                        <table class="table table-centered table-hover align-middle mb-0 text-dark">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><span class="fw-semibold text-dark">{{ $item->description }}</span></td>
                                    <td class="text-muted fs-12">{{ __data_pt($item->created_at) }}</td>
                                    <td class="text-end">
                                        <form action="{{ route('controle-acesso.destroy', $item->id) }}" method="post" id="form-{{$item->id}}" class="m-0">
                                            @method('delete')
                                            @csrf
                                            <div class="act-group">
                                                @can('controle_acesso_edit')
                                                <a class="act-btn act-edit" href="{{ route('controle-acesso.edit', [$item->id]) }}" title="Editar">
                                ...
                                <tr>
                                    <td colspan="3">
                                        <div class="empty-state">
                                            ...
                                            <p>Nenhum controle de acesso encontrado.</p>
                                        </div>
                                    </td>
                                </tr>
                                @endforelse
                ...
                <div class="modulo-footer">
                    <div>
                        <span class="fs-12" style="color:#94a3b8;">Exibindo <strong>{{ $data->count() }}</strong> de <strong>{{ $data->total() }}</strong> controles</span>
                    </div>

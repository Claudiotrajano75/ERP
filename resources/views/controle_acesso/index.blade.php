            ...
            <div class="card-header modulo-header-gradient py-3 px-4">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <div>
                        ...
                        <a href="{{ route('controle-acesso.create') }}" class="btn btn-light btn-sm px-3 text-dark">
                            <i class="ri-add-circle-line align-middle me-1"></i> Novo Controle
                        </a>
                        @endcan
                    </div>
                </div>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-3 col-12 ms-auto d-flex align-items-end">
                            <div class="d-flex gap-2 w-100">
                                ...
                                <a class="btn btn-limpar px-3" href="{{ route('controle-acesso.index') }}" title="Limpar Filtros">
                                    ...
                                    <td class="text-end">
                                        <form action="{{ route('controle-acesso.destroy', $item->id) }}" method="post" id="form-{{$item->id}}" class="m-0">
                                            ...
                                            <div class="modulo-action-group">
                                                ...
                                                <a class="btn btn-warning btn-sm text-white" href="{{ route('controle-acesso.edit', [$item->id]) }}" title="Editar">

                ...
                <div class="card-header modulo-header-gradient py-3 px-4">
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            ...
                            <p class="text-muted mb-0 modulo-subtitle fs-13">Gere uma nova rodada de cotação de preços para um ou múltiplos distribuidores cadastrados.</p>
                        </div>
                        <div>
                            <a href="{{ route('cotacoes.index') }}" class="btn btn-light btn-sm px-3 text-dark">

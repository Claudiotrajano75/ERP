                ...
                <div class="modulo-glass-filter p-3 mb-4">
                    ...
                    <div class="row g-2 align-items-end">
                        <div class="col-md-3 col-12">
                            {!!Form::select('fornecedor_id', 'Fornecedor', $fornecedor ? [$fornecedor->id => $fornecedor->info] : [])
                        ...
                        <div class="col-md-2 col-6">
                            {!!Form::select('estado', 'Estado / Status', [
                                'novo' => 'Nova',
                                'rejeitada' => 'Rejeitada',
                        ...
                        <div class="col-md-3 col-12 ms-auto">
                            <div class="d-flex gap-2">
                                ...
                                <a class="btn btn-danger btn-sm px-3" href="{{ route('cotacoes.index') }}">

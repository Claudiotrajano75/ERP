                ...
                <div class="card-header modulo-header-gradient py-3 px-4">
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            ...
                            <p class="text-muted mb-0 modulo-subtitle fs-13">Envie links de cotações para distribuidores
                                parceiros, compare propostas e gere compras automáticas a partir das respostas.</p>
                        </div>
                        <div>
                            @can('cotacao_create')
        ...
        '' => 'Todas'
                            ...
                            <div class="col-md-3 col-12 ms-auto d-flex align-items-end">
                                <div class="d-flex gap-2 w-100">
                                    ...
                                    <a class="btn btn-limpar px-3" href="{{ route('cotacoes.index') }}"
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if($item->estado == 'aprovada')
                                                    <span class="modulo-badge modulo-badge-success"><i class="ri-check-line"></i>
                                                        Aprovada</span>
                                                @elseif($item->estado == 'rejeitada')
                                                    <span class="modulo-badge modulo-badge-danger"><i class="ri-close-line"></i>
                                                        Rejeitada</span>
                                                @elseif($item->estado == 'respondida')
                                                    <span class="modulo-badge modulo-badge-info"><i class="ri-chat-1-line"></i>
                                                        Respondida</span>
                                                @else
                                                    <span class="modulo-badge modulo-badge-warning"><i class="ri-time-line"></i>
                                                        Nova</span>
                                                @endif
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-end">
                                                <form action="{{ route('cotacoes.destroy', $item->id) }}" method="post"
                                                    ...
                                                    <div class="d-inline-flex gap-1">
                                                        @if($item->estado != 'aprovada')
                                                            @can('cotacao_edit')
                                                                <a class="btn btn-warning btn-sm text-white"
                                                                    href="{{ route('cotacoes.edit', $item->id) }}"
                                                        ...
                                                        <a title="Copiar Link de Resposta do Fornecedor" target="_blank"
                                                            class="btn btn-dark btn-sm text-white"
                                                            href="{{ route('cotacoes.resposta', $item->hash_link) }}">
                                                            <i class="ri-external-link-line"></i>
                                                        </a>

                                                        @if($item->estado == 'respondida' || $item->estado == 'aprovada')
                                                            <a title="Ver e Avaliar Resposta"
                                                                class="btn btn-primary btn-sm text-white"
                                                                href="{{ route('cotacoes.show', $item->id) }}">
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="10" class="text-center text-muted py-4">Nenhuma cotação de compra
                                                gerada no período.</td>
                                        </tr>
                                    @endforelse
                                </tbody>
                            </table>

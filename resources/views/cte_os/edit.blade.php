        ...
        <div class="col-lg-12">
            <div class="card border-0 shadow-sm modulo-form-card">
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            ...
                            <p class="text-muted mb-0 modulo-subtitle fs-13">
                                Atualize os dados do Conhecimento de Transporte OS selecionado.
                            </p>
                        </div>
                        <div>
                            <a href="{{ route('cte-os.index') }}" class="btn btn-light btn-sm px-3 text-dark">
                ...
                <div class="card-body p-4">
                    {!!Form::open()->fill($item)->put()->route('cte-os.update', [$item->id])->multipart()!!}

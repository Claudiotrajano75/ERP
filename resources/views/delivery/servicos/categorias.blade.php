                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            <h4 class="mb-1 modulo-title d-flex align-items-center gap-2">
                                ...
                                Categorias de Serviço Marketplace
                            </h4>
                            <p class="mb-0 modulo-subtitle fs-13">
                                Gerencie as categorias dos seus serviços no marketplace.
                            </p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="filter-box">
                        ...
                        <div class="row align-items-end g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <a id="clear-filter" class="btn btn-light border px-3" href="{{ route('servico-marketplace.categorias') }}">
                    ...
                    <div class="table-responsive-sm">
                        <table class="table table-custom mb-0">
                            <thead>
                                <tr>
                                    <th>Nome</th>
                                    <th width="20%">Visível no Marketplace</th>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-check form-switch">
                                            <input class="form-check-input switch-check shadow-none" type="checkbox" role="switch" value="{{ $item->id }}" style="cursor: pointer;" @if($item->marketplace) checked @endif>
                                            <label class="form-check-label ms-2 text-muted" style="font-size: 13px;">@if($item->marketplace) Ativado @else Desativado @endif</label>
                                        </div>
                                    </td>

                                    <td>
                                        <a class="btn btn-warning btn-sm text-white" href="{{ route('categoria-servico.edit', [$item->id]) }}" data-bs-toggle="tooltip" title="Editar">

@extends('layouts.app', ['title' => 'Editar Destaque'])
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            ...
                            <p class="mb-0 modulo-subtitle fs-13">
                                Altere as informações do produto ou serviço em destaque no marketplace.
                            </p>
                        </div>
                        <a href="{{ route('destaque-marketplace.index') }}" class="btn btn-light text-dark fw-semibold px-4 py-2">

                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            <h4 class="mb-1 modulo-title d-flex align-items-center gap-2">
                                ...
                                Configurar Nota de Devolução
                            </h4>
                            @if(__countLocalAtivo() > 1 && isset($caixa))
                            <p class="text-muted mb-0 modulo-subtitle fs-13">
                                Local / Filial: <strong class="text-white">{{ $caixa->localizacao ? $caixa->localizacao->descricao : '' }}</strong>
                            </p>
                            @else
                            <p class="text-muted mb-0 modulo-subtitle fs-13">Revise os dados do XML importado e configure os parâmetros da devolução antes de salvar.</p>
                            @endif
                        </div>
                        <div>

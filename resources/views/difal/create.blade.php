        ...
        <div class="col-lg-12">
            <div class="card border-0 shadow-sm modulo-form-card">
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            ...
                            <p class="text-muted mb-0 modulo-subtitle fs-13">
                                Preencha os campos abaixo para cadastrar um novo registro DIFAL.
                            </p>
                        </div>
                        <div>
                            <a href="{{ route('difal.index') }}" class="btn btn-light btn-sm px-3 text-dark">
                ...
                <div class="card-body p-4">
                    ...
                    {{-- ⚠️ Botões já estão no _forms.blade.php — não duplicar aqui --}}

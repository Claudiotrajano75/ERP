                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        ...
                        <p class="text-muted mb-0 modulo-subtitle fs-13">
                            Cadastro de alíquotas e percentuais por UF e CFOP.
                        </p>
                    </div>
                    <div class="d-inline-flex gap-2">
                        @can('difal_view')
                        <a href="{{ route('difal.create') }}" class="btn btn-light btn-sm px-3 text-dark">
                            <i class="ri-add-circle-line align-middle me-1"></i> Novo DIFAL
                        </a>
                        @endcan
                    </div>
                </div>
            ...
            <div class="card-body p-4">
                ...
                <div class="modulo-glass-filter p-3 mb-4">
                    ...
                    <div class="row g-2 align-items-end">
                        ...
                        <div class="col-md-2 col-6">
                            <a class="btn btn-danger btn-sm w-100" href="{{ route('difal.index') }}">
                        ...
                        <table class="table table-centered table-hover align-middle mb-0 text-dark">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="fw-semibold text-dark">{{ $item->cfop }}</span>
                                    </td>
                                    ...
                                    <td class="text-end">
                                        <form action="{{ route('difal.destroy', $item->id) }}" method="post"
                                            ...
                                            <div class="modulo-action-group">
                                                ...
                                                <a class="btn btn-warning btn-sm text-white"
                                                   href="{{ route('difal.edit', [$item->id]) }}" title="Editar">

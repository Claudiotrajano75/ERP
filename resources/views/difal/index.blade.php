                ...
                <div class="modulo-glass-filter-premium">
                    <div class="filtro-premium-header">
                        <h5 class="filtro-premium-title">
                            <i class="ri-search-line"></i> Filtrar Alíquotas DIFAL
                        </h5>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-8 col-12">
                            ...
                            {!!Form::text('cfop', '')->attrs(['class' => 'form-control', 'placeholder' => 'Digite o CFOP (ex: 6102)...'])!!}
                        </div>
                        <div class="col-md-3 col-12 ms-auto d-flex align-items-end">
                            <div class="d-flex gap-2 w-100">
                                ...
                                <a class="btn btn-limpar px-3" href="{{ route('difal.index') }}" title="Limpar Filtros">

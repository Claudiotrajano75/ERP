                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            <h4 class="mb-1 modulo-title d-flex align-items-center gap-2">
                                ...
                                Cadastrar Novo Evento de Folha
                            </h4>
                            <p class="text-muted mb-0 modulo-subtitle fs-13">Cadastre um provento ou desconto recorrente ou variável para holerites de funcionários.</p>
                        </div>
                        <div>
                            <a href="{{ route('evento-funcionarios.index') }}" class="btn btn-light btn-sm px-3 text-dark">

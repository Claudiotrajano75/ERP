            ...
            <div class="card-header modulo-header-gradient py-3 px-4">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        ...
                        <p class="text-muted mb-0 modulo-subtitle fs-13">Cadastre proventos (soma) ou descontos (diminui) mensais para controle de holerite dos funcionários.</p>
                    </div>
                    <div>
                        <a href="{{ route('evento-funcionarios.create') }}" class="btn btn-light btn-sm px-3 text-dark">
                            <i class="ri-add-circle-line align-middle me-1"></i> Novo Evento
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="modulo-glass-filter-premium">
                    <div class="filtro-premium-header">
                        <h5 class="filtro-premium-title">
                            <i class="ri-search-line"></i> Filtrar Eventos
                        </h5>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-8 col-12">
                            <label class="form-label"><i class="ri-calendar-event-line"></i> Pesquisar por Nome</label>
                            {!!Form::text('nome', '')->attrs(['class' => 'form-control', 'placeholder' => 'Digite o nome do evento...'])!!}
                        </div>
                        <div class="col-md-3 col-12 ms-auto d-flex align-items-end">
                            <div class="d-flex gap-2 w-100">
                                ...
                                <a class="btn btn-limpar px-3" href="{{ route('evento-funcionarios.index') }}" title="Limpar Filtros">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="badge bg-success-subtle text-success border border-success-subtle px-2 py-1 fs-11">Soma (Provento)</span>
                                        @else
                                        <span class="badge bg-danger-subtle text-danger border border-danger-subtle px-2 py-1 fs-11">Diminui (Desconto)</span>
                                        @endif
                                    </td>
                                    ...
                                    <td class="text-end">
                                        <form action="{{ route('evento-funcionarios.destroy', $item->id) }}" method="post" id="form-{{$item->id}}" class="m-0">
                                            ...
                                            <div class="modulo-action-group">
                                                <a class="btn btn-warning btn-sm text-white" href="{{ route('evento-funcionarios.edit', [$item->id]) }}" title="Editar Evento">
                                                    <i class="ri-pencil-line"></i>
                                                </a>
                                                <button type="button" class="btn btn-danger btn-sm btn-delete" title="Excluir Evento">
                                ...
                                <tr>
                                    <td colspan="8">
                                        <div class="modulo-empty">
                                            ...
                                            <p>Nenhum evento de folha cadastrado.</p>
                                        </div>
                                    </td>
                                </tr>
                                @endforelse

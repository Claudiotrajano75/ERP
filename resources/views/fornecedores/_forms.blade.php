<div class="row g-3 text-dark">
    ...
    <div class="col-12">
        <h5 class="text-dark border-bottom pb-2 mb-3"><i class="ri-user-line text-primary me-2 align-middle fs-18"></i> 1. Identificação do Fornecedor</h5>
        <div class="row g-3">
    ...
    <div class="col-12 mt-4">
        <h5 class="text-dark border-bottom pb-2 mb-3"><i class="ri-map-pin-line text-primary me-2 align-middle fs-18"></i> 2. Endereço do Distribuidor</h5>
        <div class="row g-3">
            <div class="col-md-4 col-12">
                @isset($item)
    ...
    <div class="col-12 mt-4">
        ...
        <div class="d-flex align-items-center justify-content-end gap-2">
            <a href="{{ route('fornecedores.index') }}" class="btn btn-outline-secondary px-4">
                <i class="ri-close-line align-middle me-1"></i> Cancelar
            </a>
            <button type="submit" class="btn {{ $formType === 'edit' ? 'btn-primary' : 'btn-success' }} px-4" id="btn-store">
                <i class="ri-save-line align-middle me-1"></i> {{ $formType === 'edit' ? 'Salvar Alterações' : 'Salvar Fornecedor' }}
            </button>
        </div>
    </div>

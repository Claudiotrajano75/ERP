                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            ...
                            <p class="text-muted mb-0 modulo-subtitle fs-13">
                                Cadastre seus distribuidores, parceiros comerciais e consulte históricos completos de compras realizadas.
                            </p>
                        </div>
                        <div class="d-flex align-items-center gap-2">
                            @can('fornecedores_create')
                            <a href="{{ route('fornecedores.import') }}" class="dash-btn dash-btn-light">
                                <i class="ri-file-upload-line"></i> Importar Planilha
                            </a>
                            <a href="{{ route('fornecedores.create') }}" class="dash-btn dash-btn-primary">
                                <i class="ri-add-circle-line"></i> Novo Fornecedor
                            </a>
                            @endcan
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-4 col-6">
                            <div class="stat-card stat-emerald">
                                <div>
                                    <div class="stat-label">Com Compras Registradas</div>
                                    <div class="stat-value mt-1">{{ $stats['total_compras'] }}</div>
                                </div>
                    ...
                    <div class="modulo-glass-filter-premium mb-4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-5 col-12">
                                ...
                                {!!Form::text('razao_social', '')->attrs(['class' => 'form-control', 'placeholder' => 'Digite a razão social ou nome fantasia...'])!!}
                            </div>
                            <div class="col-md-4 col-6">
                            ...
                            <div class="col-md-3 col-12 ms-auto d-flex align-items-end">
                                <div class="d-flex gap-2 w-100">
                                    ...
                                    <a class="dash-btn dash-btn-light px-3" href="{{ route('fornecedores.index') }}" title="Limpar Filtros">
                            ...
                            <table class="table table-hover align-middle mb-0 text-dark">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="text-muted fs-12">{{ $item->endereco }}</span>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-end">
                                            <form action="{{ route('fornecedores.destroy', $item->id) }}" method="post" id="form-{{$item->id}}" class="m-0">
                                                ...
                                                @csrf
                                                <div class="act-group">
                                                    <a title="Histórico de Compras" class="act-btn act-add" href="{{ route('fornecedores.historico', [$item->id]) }}">
                                                        <i class="ri-file-list-3-line"></i>
                                                    </a>
                                                    @can('fornecedores_edit')
                                                    <a class="act-btn act-edit" href="{{ route('fornecedores.edit', [$item->id]) }}" title="Editar Fornecedor">
                                                        <i class="ri-pencil-line"></i>
                                                    </a>
                                                    @endcan
                                                    @can('fornecedores_delete')
                                                    <button type="button" class="act-btn act-del btn-delete" title="Excluir Fornecedor">

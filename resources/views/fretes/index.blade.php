                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        ...
                        <p class="text-muted mb-0 modulo-subtitle fs-13">
                            Gerencie os fretes, despesas e acompanhe o status das viagens.
                        </p>
                    </div>
                    <div class="d-inline-flex gap-2">
                        @can('frete_create')
                        <a href="{{ route('fretes.create') }}" class="btn btn-light btn-sm px-3 text-dark">
                            <i class="ri-add-circle-line align-middle me-1"></i> Novo Frete
                        </a>
                        @endcan
                    </div>
                </div>
            ...
            <div class="card-body p-4">
                            ...
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h4 class="text-uppercase fs-12 mt-0 text-white-50">Valor Total Fretes</h4>
                    ...
                    <div class="col-md-3 col-6">
                        <div class="card widget-icon-box text-bg-success mb-0">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h4 class="text-uppercase fs-12 mt-0 text-white-50">Total Despesas</h4>
                                        <h3 class="my-2 text-white fs-18">R$ {{ __moeda($data->sum('total_despesa')) }}</h3>
                                    </div>
                                    <div class="avatar-sm flex-shrink-0">
                                        <span class="avatar-title bg-white bg-opacity-25 text-white rounded rounded-3 fs-3 widget-icon-box-avatar shadow">
                    ...
                    <div class="col-md-3 col-6">
                        <div class="card widget-icon-box text-bg-warning mb-0">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h4 class="text-uppercase fs-12 mt-0 text-white-50">Lucro Líquido</h4>
                                        <h3 class="my-2 text-white fs-18">R$ {{ __moeda($data->sum('total') - $data->sum('total_despesa')) }}</h3>
                                    </div>
                                    <div class="avatar-sm flex-shrink-0">
                                        <span class="avatar-title bg-white bg-opacity-25 text-white rounded rounded-3 fs-3 widget-icon-box-avatar shadow">
                    ...
                    <div class="col-md-3 col-6">
                        <div class="card widget-icon-box text-bg-primary mb-0">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <div class="flex-grow-1 overflow-hidden">
                                        <h4 class="text-uppercase fs-12 mt-0 text-white-50">Total de Fretes</h4>
                ...
                <div class="modulo-glass-filter p-3 mb-4">
                    ...
                    <div class="row g-2 align-items-end">
                        ...
                        <div class="col-md-2 col-6">
                            <a class="btn btn-danger btn-sm w-100" href="{{ route('fretes.index') }}">
                        ...
                        <table class="table table-centered table-hover align-middle mb-0 text-dark">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="fw-semibold text-dark d-block">{{ $item->cliente->info }}</span>
                                    ...
                                    <td>R$ {{ __moeda($item->total_despesa) }}</td>
                                    @if(__countLocalAtivo() > 1)
                                        ...
                                        <form action="{{ route('fretes.destroy', $item->id) }}" method="post"
                                            ...
                                            <div class="modulo-action-group">
                                                ...
                                                <a class="btn btn-info btn-sm text-white"
                                                   href="{{ route('fretes.show', $item->id) }}" title="Visualizar">
                                                    <i class="ri-eye-line"></i>
                                                </a>
                                                @endcan
                                                @can('frete_edit')
                                                <a class="btn btn-warning btn-sm text-white"
                                                   href="{{ route('fretes.edit', $item->id) }}" title="Editar">
                            ...
                            <tfoot>
                                <tr>
                                    ...
                                    <td class="text-primary">R$ {{ __moeda($data->sum('total')) }}</td>
                                    <td class="text-danger">R$ {{ __moeda($data->sum('total_despesa')) }}</td>
                                    <td colspan="{{ __countLocalAtivo() > 1 ? 6 : 5 }}"></td>
                                </tr>
                            </tfoot>
                        </table>
                    </div>

        ...
        <div class="card border-0 shadow-sm text-dark modulo-form-card">
            ...
            <div class="card-header modulo-header-gradient py-3 px-4">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        ...
                        <p class="text-muted mb-0 modulo-subtitle fs-13">Gerencie as vendas realizadas no PDV (Ponto de Venda), acompanhe o status de cada transação e emita NFCe.</p>
                    </div>
            ...
            <div class="card-body p-4">
                        ...
                        <table class="table table-centered table-hover align-middle mb-0 text-dark">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <form action="{{ route('frontbox.destroy', $item->id) }}" method="post" id="form-{{$item->id}}" class="m-0">
                                            @method('delete')
                                            @csrf
                                            <div class="modulo-action-group">
                                                <a title="Imprimir não fiscal" class="btn btn-primary btn-sm text-white" target="_blank" href="{{ route('frontbox.imprimir-nao-fiscal', [$item->id]) }}">
                                                ...
                                                @can('pdv_edit')
                                                <a class="btn btn-warning btn-sm text-white" title="Editar venda" href="{{ route('frontbox.edit', $item->id) }}">
                                                ...
                                                @if($item->estado == 'aprovado')
                                                <a class="btn btn-success btn-sm text-white" title="Imprimir NFCe" target="_blank" href="{{ route('nfce.imprimir', [$item->id]) }}">
                                                    <i class="ri-printer-line"></i>
                                                </a>
                                                @endif
                                            </div>
                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mt-4">
                    <div>
                        <h5 class="m-0 text-dark">Total das Vendas: <strong class="text-success fs-16">R$ {{ __moeda($data->sum('total')) }}</strong></h5>
                    </div>
                    <div>

<div class="row mt-1 products product-line-{{$code}}" data-estoque-minimo="{{ $item->estoque_minimo }}" data-estoque-atual="{{ $item->estoque ? $item->estoque->quantidade : 0 }}" data-nome-produto="{{ $item->nome }}">
	<div class="col-md-2">

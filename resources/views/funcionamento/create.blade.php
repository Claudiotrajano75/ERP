    ...
    <div class="row">
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-header modulo-header-gradient py-3 px-4">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        ...
                        <p class="text-muted mb-0 modulo-subtitle fs-13">Configure o horário comercial padrão do colaborador selecionado.</p>
                    </div>
            ...
            <div class="card-body p-4">
                {!!Form::open()->post()->route('funcionamentos.store')!!}
                @include('funcionamento._forms', ['formType' => 'create'])
                {!!Form::close()!!}
            </div>

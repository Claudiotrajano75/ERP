...
/* ─── Horários ─── */
.horario-entrada { font-weight: 700; color: #15803d; }
.horario-saida { font-weight: 700; color: #b91c1c; }
        ...
        <div class="card border-0 shadow-sm">
            ...
            <div class="card-header modulo-header-gradient py-3 px-4">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        ...
                        <p class="text-muted mb-0 modulo-subtitle fs-13">Configure a grade horária e expediente dos profissionais para cada dia da semana.</p>
                    </div>
                    <div class="d-flex gap-2 flex-wrap">
                        <a href="{{ route('funcionamentos.index') }}" class="dash-btn dash-btn-light">
                            <i class="ri-refresh-line"></i> Atualizar
                        </a>
                        <a href="{{ route('funcionamentos.create') }}" class="dash-btn dash-btn-primary">
            ...
            <div class="card-body p-4">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-12 col-md-4">
                        <div class="stat-card stat-indigo">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    <div class="st-label">Total de Horários</div>
                                    <div class="st-value">{{ $stats['total'] ?? $data->total() }}</div>
                                    <div class="st-sub">turnos cadastrados</div>
                                </div>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="stat-card stat-green">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    <div class="st-label">Profissionais Ativos</div>
                                    <div class="st-value">{{ $stats['profissionais_configurados'] ?? 0 }}</div>
                                    <div class="st-sub">com expediente definido</div>
                                </div>
                    ...
                    <div class="col-12 col-md-4">
                        <div class="stat-card stat-amber">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    <div class="st-label">Total de Colaboradores</div>
                                    <div class="st-value">{{ $stats['total_profissionais'] ?? count($funcionarios) }}</div>
                                    <div class="st-sub">profissionais cadastrados</div>
                                </div>
                                <div class="st-icon"><i class="ri-team-line"></i></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modulo-glass-filter-premium">
                    ...
                    <form method="get" action="{{ route('funcionamentos.index') }}">
                        <div class="row g-3 align-items-end">
                            ...
                            <div class="col-md-3 col-12 d-flex gap-2">
                                ...
                                <a class="dash-btn dash-btn-light px-3" href="{{ route('funcionamentos.index') }}" title="Limpar Filtros">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="pill pill-role">
                                            <i class="ri-calendar-line"></i> {{ $item->getDiaStr() }}
                                        </span>
                                    </td>
                                    <td>
                                        <span class="horario-entrada font-monospace fs-13">
                                            <i class="ri-login-box-line me-1"></i>{{ \Carbon\Carbon::parse($item->inicio)->format('H:i') }} hs
                                        </span>
                                    </td>
                                    <td>
                                        <span class="horario-saida font-monospace fs-13">
                                            <i class="ri-logout-box-line me-1"></i>{{ \Carbon\Carbon::parse($item->fim)->format('H:i') }} hs
                                        </span>
                                    </td>
                                    <td class="text-end">
                                        <form action="{{ route('funcionamentos.destroy', $item->funcionario_id) }}" method="post" id="form-{{$item->id}}" class="m-0">
                                            @csrf
                                            @method('delete')
                                            <div class="act-group">
                                                <a class="act-btn act-edit" href="{{ route('funcionamentos.edit', [$item->funcionario_id]) }}" title="Editar Grade Completa"><i class="ri-pencil-line"></i></a>
                                                <button type="button" class="act-btn act-del btn-delete" title="Excluir Horários"><i class="ri-delete-bin-line"></i></button>
                                            </div>
                                        </form>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="5">
                                        <div class="empty-state">
                                            ...
                                            <p>Nenhum horário de funcionamento cadastrado.</p>
                                        </div>
                                    </td>
                                </tr>
                                @endforelse
                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2 mt-3">
                    <div class="fs-12" style="color:#94a3b8;">
                        Exibindo <strong>{{ $data->count() }}</strong> de <strong>{{ $data->total() }}</strong> horários cadastrados
                    </div>
                    <div>

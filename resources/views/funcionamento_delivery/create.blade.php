                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            ...
                            <p class="mb-0 modulo-subtitle fs-13">
                                Adicione um novo horário de funcionamento para o delivery.
                            </p>
                        </div>
                        <a href="{{ route('funcionamento-delivery.index') }}" class="btn btn-light text-dark fw-semibold px-4 py-2">

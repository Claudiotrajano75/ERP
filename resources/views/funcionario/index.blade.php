                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            ...
                            <p class="text-muted mb-0 modulo-subtitle fs-13">
                                Gerencie colaboradores, vencimentos salariais, percentual de comissões e atribuição de serviços.
                            </p>
                        </div>
                        <div class="d-flex align-items-center gap-2">
                            @can('funcionario_create')
                            <a href="{{ route('comissao.index') }}" class="dash-btn dash-btn-light">
                                <i class="ri-wallet-2-line"></i> Comissões de Vendas
                            </a>
                            <a href="{{ route('funcionarios.create') }}" class="dash-btn dash-btn-primary">
                                <i class="ri-add-circle-line"></i> Novo Funcionário
                            </a>
                            @endcan
                        </div>
                    </div>
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-md-4 col-6">
                            <div class="stat-card stat-amber">
                                <div>
                                    <div class="stat-label">Folha Salarial Base</div>
                                    <div class="stat-value mt-1">R$ {{ __moeda($stats['folha_salarial']) }}</div>
                                </div>
                    ...
                    <div class="modulo-glass-filter-premium mb-4">
                        <div class="filtro-premium-header">
                            <h5 class="filtro-premium-title">
                                <i class="ri-search-line"></i> Filtrar Funcionários
                            </h5>
                        </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-8 col-12">
                                <label class="form-label"><i class="ri-user-line"></i> Pesquisar por Nome do Colaborador</label>
                            ...
                            <div class="col-md-3 col-12 ms-auto d-flex align-items-end">
                                <div class="d-flex gap-2 w-100">
                                    ...
                                    <a class="dash-btn dash-btn-light px-3" href="{{ route('funcionarios.index') }}" title="Limpar Filtros">
                            ...
                            <table class="table table-hover align-middle mb-0 text-dark">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="d-flex align-items-center gap-2 mt-0.5">
                                                        @if($item->codigo)
                                                            <span class="badge bg-light text-muted border px-1.5 py-0.5 fs-10">Cód: {{ $item->codigo }}</span>
                                                        @endif
                                                        @if($item->telefone)
                                                            <span class="text-muted fs-11"><i class="ri-phone-line me-0.5"></i>{{ $item->telefone }}</span>
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <td>
                                            <span class="fw-bold text-success fs-13">R$ {{ __moeda($item->salario) }}</span>
                                        </td>
                                        <td>
                                        ...
                                        <td class="text-end">
                                            <form action="{{ route('funcionarios.destroy', $item->id) }}" method="post" id="form-{{$item->id}}" class="m-0">
                                                @method('delete')
                                                @csrf
                                                <div class="act-group">
                                                    @can('funcionario_edit')
                                                    <a href="{{ route('funcionarios.atribuir', [$item->id]) }}" class="act-btn act-add" title="Atribuir Serviços a Este Funcionário">
                                                        <i class="ri-user-settings-line"></i>
                                                    </a>
                                                    <a class="act-btn act-edit" href="{{ route('funcionarios.edit', [$item->id]) }}" title="Editar Funcionário">
                                                        <i class="ri-pencil-line"></i>
                                                    </a>
                                                    @endcan
                                                    @can('funcionario_delete')
                                                    <button type="button" class="act-btn act-del btn-delete" title="Excluir Funcionário">

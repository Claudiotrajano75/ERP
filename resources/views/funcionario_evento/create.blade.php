@extends('layouts.app', ['title' => 'Associar Eventos'])
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            <h4 class="mb-1 modulo-title d-flex align-items-center gap-2">
                                ...
                                Associar Eventos ao Funcionário
                            </h4>
                            <p class="text-muted mb-0 modulo-subtitle fs-13">Vincule proventos e descontos dinâmicos à folha salarial de um colaborador específico.</p>
                        </div>
                        <div>

@extends('layouts.app', ['title' => 'Editar Eventos Associados'])
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            <h4 class="mb-1 modulo-title d-flex align-items-center gap-2">
                                ...
                                Editar Eventos de: <strong class="text-white ms-1">{{ $item->nome }}</strong>
                            </h4>
                            <p class="text-muted mb-0 modulo-subtitle fs-13">Gerencie os valores e condições dos eventos salariais do colaborador selecionado.</p>
                        </div>
                        <div>
                            <a href="{{ route('funcionario-eventos.index') }}" class="btn btn-light btn-sm px-3 text-dark">

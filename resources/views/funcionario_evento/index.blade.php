            ...
            <div class="card-header modulo-header-gradient py-3 px-4">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        ...
                        <p class="text-muted mb-0 modulo-subtitle fs-13">Vincule proventos e descontos da folha de pagamento especificando valores individuais por colaborador.</p>
                    </div>
                    <div>
                        <a href="{{ route('funcionario-eventos.create') }}" class="btn btn-light btn-sm px-3 text-dark">
                            <i class="ri-add-circle-line align-middle me-1"></i> Associar Eventos
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="modulo-glass-filter-premium">
                    ...
                    <div class="row g-3">
                        <div class="col-md-8 col-12">
                            <label class="form-label"><i class="ri-user-line"></i> Pesquisar por Funcionário</label>
                        ...
                        <div class="col-md-3 col-12 ms-auto d-flex align-items-end">
                            <div class="d-flex gap-2 w-100">
                                ...
                                <a class="btn btn-limpar px-3" href="{{ route('funcionario-eventos.index') }}" title="Limpar Filtros">
                                    ...
                                    <td class="text-end">
                                        <form action="{{ route('funcionario-eventos.destroy', $item->id) }}" method="post" id="form-{{$item->id}}" class="m-0">
                                            ...
                                            <div class="modulo-action-group">
                                                <a class="btn btn-warning btn-sm text-white" href="{{ route('funcionario-eventos.edit', [$item->id]) }}" title="Editar Associação">
                                                    <i class="ri-pencil-line"></i>
                                                </a>
                                                <button type="button" class="btn btn-danger btn-sm btn-delete" title="Remover Todos Eventos">

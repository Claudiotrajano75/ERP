@extends('layouts.app', ['title' => 'Nova Importação IBPT'])
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            ...
                            <p class="modulo-subtitle">
                                Importe o arquivo .CSV do IBPT contendo as alíquotas tributárias estaduais e federais.
                            </p>
                        </div>
                        <div>
                            <a href="{{ route('ibpt.index') }}" class="btn btn-light btn-sm text-dark">

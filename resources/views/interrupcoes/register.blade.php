            ...
            <div class="card border-0 shadow-sm modulo-form-card">
                ...
                <div class="card-header modulo-header-gradient py-3 px-4">
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        ...
                        <div>
                            <a href="{{ route('interrupcoes.index') }}" class="btn btn-light btn-sm px-3 text-dark">
                ...
                <div class="card-body p-4">
                    <div class="row g-3">
                        <div class="col-md-4 col-12">
                            {!!Form::text('dia', 'Dia da Semana')->attrs(['class' => 'form-control'])->value($item->dia)->readonly()!!}
                        </div>
                        <input type="hidden" name="dia_id" value="{{ $item->id }}">

                        <div class="col-md-3 col-6">
                            {!!Form::text('inicio', 'Horário de Início')->attrs(['class' => 'form-control timer', 'data-mask' => '00:00', 'placeholder' => '00:00'])->required()!!}
                        </div>
                        <div class="col-md-3 col-6">
                            {!!Form::text('fim', 'Horário de Término')->attrs(['class' => 'form-control timer', 'data-mask' => '00:00', 'placeholder' => '00:00'])->required()!!}
                        </div>

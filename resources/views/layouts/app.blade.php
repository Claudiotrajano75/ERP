    ...
    <div class="wrapper">
        ...
        <div class="leftside-menu">
            ...
            <div class="h-100" id="leftside-menu-container" data-simplebar>
                <!-- Leftbar User -->
                <div class="leftbar-user p-3 text-blue-50 bg-light" id="step5">
                    <a @if (!__isContador()) href="{{ route('usuarios.profile', Auth::user()->id) }}" @endif
                        ...
                        <div class="flex-shrink-0">
                            ...
                            @else
                                <img src="/assets/images/users/avatar-4.jpg" height="42"
                                        ...
                                        <ul class="side-nav-second-level">
                                            ...
                                            @if (__isPlanoFiscal())
                                                @can('config_produto_fiscal_view')
                                                    <li>
                                                        <a href="{{ route('produtopadrao-tributacao.index') }}">Configuração
                                                            Padrão Fiscal</a>
                                                    </li>
                                                @endcan
                                            @endif
                                            ...
                                            @can('transferencia_estoque_view')
                                                <li>
                                                    <a href="{{ route('transferencia-estoque.index') }}">Transferência de
                                                        estoque</a>
                                                </li>
                                            @endcan
                                    ...
                                    <div class="collapse" id="sidebarExtendedServ">
                                        <ul class="side-nav-second-level">
                                            ...
                                            @can('ordem_servico_view')
                                                <li>
                                                    <a data-bs-toggle="collapse" href="#ordemservico" aria-expanded="false"
                                                        aria-controls="ordemservico">
                                    ...
                                    <div class="collapse" id="sidebarGestaoPessoal">
                                        <ul class="side-nav-second-level">
                                            ...
                                            @can('apuracao_mensal_view')
                                                ...
                                                <li>
                                                    <a href="{{ route('funcionario-eventos.index') }}">Funcionários x
                                                        Eventos</a>
                                                </li>
                                                <li>
                                    ...
                                    <div class="collapse" id="sidebarCompra">
                                        <ul class="side-nav-second-level">
                                            ...
                                            @can('relacao_dados_fornecedor_view')
                                                <li>
                                                    <a href="{{ route('relacao-dados-fornecedor.index') }}"
                                                        data-toggle="fullscreen" class="dropdown-item">
                                    ...
                                    <div class="collapse" id="sidebarControleFrete">
                                        <ul class="side-nav-second-level">
                                            @can('tipo_despesa_frete_view')
                                                <li>
                                                    <a href="{{ route('tipo-despesa-frete.index') }}">Tipos de despesa de
                                                        frete</a>
                                                </li>
                                            @endcan
                                            @can('frete_view')
                                            ...
                                            @can('manutencao_veiculo_view')
                                                <li>
                                                    <a href="{{ route('manutencao-veiculos.index') }}">Manuetenção de
                                                        veículos</a>
                                                </li>
                                            @endcan
                                        </ul>
                                    ...
                                    <li class="side-nav-item">
                                        ...
                                        <div class="collapse" id="sidebarEcommerce">
                                            <ul class="side-nav-second-level">
                                                ...
                                                <li>
                                                    <a target="_blank" href="{{ route('config-ecommerce.site') }}">Ver
                                                        site</a>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <li class="side-nav-item">
                                        ...
                                        <div class="collapse" id="sidebarMarketPlace">
                                            <ul class="side-nav-second-level">
                                                ...
                                                <li>
                                                    <a
                                                        href="{{ route('funcionamento-delivery.index') }}">Funcionamento</a>
                                                </li>

        ...
        <div class="card border-0 shadow-sm text-dark">
            ...
            <div class="card-header modulo-header-gradient py-3 px-4">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <div>
                        @can('marcas_create')
                        <a href="{{ route('marcas.create') }}" class="btn btn-light btn-sm px-3 text-dark">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-3 col-12 ms-auto d-flex align-items-end">
                            <div class="d-flex gap-2 w-100">
                                ...
                                <a class="btn btn-limpar px-3" href="{{ route('marcas.index') }}" title="Limpar Filtros">
                                    ...
                                    <td class="text-end">
                                        <form action="{{ route('marcas.destroy', $item->id) }}" method="post"
                                            ...
                                            <div class="modulo-action-group">
                                                ...
                                                @endcan
                                                @can('marcas_delete')
                                                <button type="button" class="btn btn-danger btn-sm btn-delete" title="Excluir Marca">

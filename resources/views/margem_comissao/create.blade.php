@extends('layouts.app', ['title' => 'Nova Margem'])
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            <h4 class="mb-1 modulo-title d-flex align-items-center gap-2">
                                ...
                                Cadastrar Margem de Comissão
                            </h4>
                            <p class="text-muted mb-0 modulo-subtitle fs-13">Vincule uma taxa de comissão a uma determinada margem de rentabilidade atingida na venda.</p>
                        </div>
                        <div>
                            <a href="{{ route('comissao-margem.index') }}" class="btn btn-light btn-sm px-3 text-dark">

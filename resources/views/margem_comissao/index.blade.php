            ...
            <div class="card-header modulo-header-gradient py-3 px-4">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        ...
                        <p class="text-muted mb-0 modulo-subtitle fs-13">Defina percentuais específicos de comissão de acordo com a margem de lucro aplicada na venda dos produtos.</p>
                    </div>
                    <div>
                        @can('categoria_servico_create')
                        <a href="{{ route('comissao-margem.create') }}" class="btn btn-light btn-sm px-3 text-dark">
                            <i class="ri-add-circle-line align-middle me-1"></i> Nova Margem Comissão
                        </a>
                        @endcan
                    </div>
                </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-centered table-hover align-middle mb-0 text-dark">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="fw-bold text-dark">{{ $item->margem }}%</td>
                                    <td class="fw-semibold text-primary">{{ $item->percentual }}%</td>
                                    <td class="text-end">
                                        <form action="{{ route('comissao-margem.destroy', $item->id) }}" method="post" id="form-{{$item->id}}" class="m-0">
                                            ...
                                            <div class="modulo-action-group">
                                                ...
                                                <a class="btn btn-warning btn-sm text-white" href="{{ route('comissao-margem.edit', [$item->id]) }}" title="Editar Margem">
                                                    <i class="ri-pencil-line"></i>
                                                </a>
                                                @endcan
                                                @can('categoria_servico_delete')
                                                <button type="button" class="btn btn-danger btn-sm btn-delete" title="Excluir Margem">
                                ...
                                <tr>
                                    <td colspan="3">
                                        <div class="modulo-empty">
                                            ...
                                            <p>Nenhuma margem de comissão cadastrada.</p>
                                        </div>
                                    </td>
                                </tr>
                                @endforelse

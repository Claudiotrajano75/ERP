<div class="modal fade modal-pdv" id="modal_finalizar_pdv2" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
                            ...
                            <table class="table table-dynamic">
                                ...
                                <tbody class="fatura">
                                    ...
                                    <tr class="dynamic-form">
                                        <td width="300">
                                            <select name="tipo_pagamento_row[]" class="form-control tipo_pagamento select2 pdv-pag-tp">

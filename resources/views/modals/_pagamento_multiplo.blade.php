<div class="modal fade modal-pdv" id="pagamento_multiplo" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-4">
                        {!! Form::select('tipo_pagamento_row', 'Tipo de Pagamento',['' => 'Selecione'] + $tiposPagamento)->attrs(['class' => 'form-select pdv-pag-tp', 'id' => 'inp-tipo_pagamento_row']) !!}
                    </div>
                    <div class="col-md-2">

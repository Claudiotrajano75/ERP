@extends('layouts.app', ['title' => 'Novo Modelo de Etiqueta'])
...
.modulo-switch-card:hover {
    border-color: #c5cae9;
    background: #fafbff;
}
.modulo-switch-card .form-check-label {
    font-size: 13px;
}
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            <h4 class="mb-1 modulo-title d-flex align-items-center gap-2">
                                ...
                                Cadastrar Novo Modelo de Etiqueta
                            </h4>
                            <p class="text-muted mb-0 modulo-subtitle fs-13">
                                Configure um novo layout físico de impressão de etiquetas personalizadas.
                            </p>
                        </div>
                        <div>
                            <a href="{{ route('modelo-etiquetas.index') }}" class="btn btn-light btn-sm px-3 text-dark">

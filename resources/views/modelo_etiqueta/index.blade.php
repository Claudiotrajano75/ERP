            ...
            <div class="card-header modulo-header-gradient py-3 px-4">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <div class="d-flex gap-2">
                        <a href="{{ route('modelo-etiquetas.create') }}" class="dash-btn dash-btn-primary">
                            <i class="ri-add-circle-line align-middle me-1"></i> Novo Modelo
                        </a>
                        @if($importar)
                        <a href="{{ route('modelo-etiquetas.import') }}" class="dash-btn dash-btn-light">
...
<div class="col-6 col-xl-3">
        <div class="stat-card stat-indigo">
            <div class="d-flex justify-content-between align-items-start">
                <div><div class="st-label">Modelos de Etiqueta</div><div class="st-value">{{ $stats['total'] }}</div><div class="st-sub">modelos configurados</div></div>
                <div class="st-icon"><i class="ri-barcode-box-line"></i></div>
            </div>
        </div>
                ...
                <div class="filter-wrap">
                    <div class="filtro-premium-header">
                        <h5 class="filter-title mb-0">
                            <i class="ri-search-line"></i> Filtrar Modelos de Etiqueta
                        </h5>
                    </div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-8 col-12">
                            <label class="form-label"><i class="ri-barcode-box-line"></i> Pesquisar por Nome</label>
                            {!!Form::text('nome', '')->attrs(['class' => 'form-control', 'placeholder' => 'Digite o nome do modelo...'])!!}
                        </div>
                        <div class="col-md-3 col-12 ms-auto d-flex align-items-end">
                            <div class="d-flex gap-2 w-100">
                                ...
                                <a class="btn btn-light border px-3" style="border-radius:10px;" href="{{ route('modelo-etiquetas.index') }}" title="Limpar Filtros">
                                    ...
                                    <td class="text-end">
                                        <form action="{{ route('modelo-etiquetas.destroy', $item->id) }}" method="post"
                                            ...
                                            <div class="act-group">
                                                ...
                                                <button type="button" class="act-btn act-del btn-delete" title="Excluir Modelo">

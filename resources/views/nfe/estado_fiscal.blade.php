...
@section('content')
@php $voltarRoute = $tipo == 'devolucao' ? 'devolucao.index' : 'nfe.index'; @endphp
        ...
        <div class="col-lg-8 col-12">
            <div class="card border-0 shadow-sm modulo-form-card">
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            ...
                            <p class="modulo-subtitle">
                                Corrija manualmente o estado da nota fiscal no sistema. Use com cautela.
                            </p>
                        </div>
                        <div>
                            <a href="{{ route($voltarRoute) }}" class="btn btn-light btn-sm px-3 text-dark">
                ...
                <div class="card-body p-4">
                    ...
                    <h5 class="section-title"><i class="ri-information-line"></i> 1. Dados da Nota Fiscal</h5>
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="info-item">
                                    ...
                                    <div class="info-value">{{ $item->cliente->razao_social }}</div>
                                </div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="info-item">
                                    <div class="info-label">CNPJ / CPF</div>
                                    <div class="info-value">{{ $item->cliente->cpf_cnpj }}</div>
                                </div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="info-item">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="info-item">
                                    ...
                                    <div class="info-value">{{ $item->fornecedor ? $item->fornecedor->razao_social : '--' }}</div>
                                </div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="info-item">
                                    <div class="info-label">CNPJ / CPF</div>
                                    <div class="info-value">{{ $item->fornecedor ? $item->fornecedor->cpf_cnpj : '--' }}</div>
                                </div>
                            </div>
                            <div class="col-md-3 col-6">
                                <div class="info-item">
                                    <div class="info-label">Cidade</div>
                                    <div class="info-value">{{ $item->fornecedor && $item->fornecedor->cidade ? $item->fornecedor->cidade->info : '--' }}</div>
                                </div>
                            </div>
                            @endif
                    ...
                    <h5 class="section-title"><i class="ri-settings-4-line"></i> 2. Novo Estado da Nota</h5>
                    ...
                    <div class="modulo-actions mt-4">
                        ...
                        <div class="d-flex gap-2 justify-content-end">
                            <a href="{{ route($voltarRoute) }}" class="btn btn-outline-secondary">

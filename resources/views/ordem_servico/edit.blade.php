                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            ...
                            <p class="text-muted mb-0 modulo-subtitle fs-13">
                                Altere as informações de cabeçalho, vigência ou responsável pela ordem selecionada.
                            </p>
                        </div>
                        <div>
                            <a href="{{ route('ordem-servico.index') }}" class="btn btn-light btn-sm px-3 text-dark">

@extends('layouts.app', ['title' => 'Editar Gabarito de Etiqueta'])
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            <h4 class="mb-0 modulo-title">
                                ...
                                Editar Gabarito #{{ $item->id }} — {{ $item->nome }}
                            </h4>
                            <p class="modulo-subtitle">
                                Atualize as medidas, espaçamentos ou campos de exibição deste gabarito.
                            </p>
                        </div>
                        <div>
                            <a href="{{ route('padroes-etiqueta.index') }}" class="btn btn-light btn-sm text-dark">

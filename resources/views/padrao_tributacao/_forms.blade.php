<style>
    .modulo-section-header { display: flex; align-items: center; gap: 8px; font-size: 14px; font-weight: 700; color: #1f2937; border-bottom: 1px solid #eef0f6 !important; padding-bottom: 10px; margin-bottom: 16px; }
    .modulo-section-header i { color: #4f46e5; }
    .modulo-section-header { color: #1f2937 !important; }

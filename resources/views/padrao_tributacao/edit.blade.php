                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            <h4 class="mb-1 modulo-title d-flex align-items-center gap-2">
                                ...
                                Editar Padrão de Tributação
                            </h4>
                            <p class="text-muted mb-0 modulo-subtitle fs-13">
                                Altere as alíquotas fiscais, enquadramentos de IPI ou códigos de benefícios do padrão selecionado.
                            </p>
                        </div>
                        <div>
...
<script type="text/javascript">
    $(function() {
        // Cálculo automático de CFOPs derivados
        $(document).on("blur", "#inp-cfop_estadual", function () {
            let val = $(this).val();
            if(val && val.length >= 4) {
                let suffix = val.substring(1, 4);
                $("#inp-cfop_outro_estado").val('6' + suffix);
                $("#inp-cfop_entrada_estadual").val('1' + suffix);
                $("#inp-cfop_entrada_outro_estado").val('2' + suffix);
            }
        });
    });
</script>

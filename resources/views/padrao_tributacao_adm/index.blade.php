        ...
        <div class="card border-0 shadow-sm modulo-form-card">
            ...
            <div class="card-header modulo-header-gradient py-3 px-4">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <div>
                        <a href="{{ route('empresas.index') }}" class="btn btn-light btn-sm px-3 text-dark me-2">
                            <i class="ri-arrow-left-line align-middle me-1"></i> Voltar
                        </a>
                        <a href="{{ route('produtopadrao-tributacao-adm.create', ['empresa='. $empresa->id]) }}" class="btn btn-light btn-sm px-3 text-dark">
                        ...
                        <table class="table table-centered table-hover align-middle mb-0 text-dark">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <form action="{{ route('produtopadrao-tributacao-adm.destroy', $item->id) }}" method="post" id="form-{{$item->id}}" class="m-0">
                                            @method('delete')
                                            @csrf
                                            <div class="modulo-action-group">
                                                <a class="btn btn-warning btn-sm text-white" href="{{ route('produtopadrao-tributacao-adm.edit', [$item->id]) }}" title="Editar">
                                ...
                                <tr>
                                    <td colspan="12">
                                        <div class="modulo-empty">
                                            ...
                                            <p>Nenhum padrão de tributação encontrado.</p>
                                        </div>
                                    </td>
                                </tr>
                                @endforelse

...
@isset($pedido)
    ...
    @endisset
                                    ...
                                    <h6 class="pdv-card-value-empty vendedor_selecionado mt-1"><i
                                            class="ri-user-search-line"></i> Nenhum</h6>
                                </div>
                                <div class="flex-shrink-0 ms-2">
                ...
                <div class="row">
                    <div class="col-1 text-center">
                        <input class="mousetrap" type="" autofocus
                            style="border: none; width: 10px; height: 10px; background-color:black" id="codBarras"
                            name="">
                    </div>
                                ...
                                @if (isset($itens))
                                    @foreach ($itens as $key => $product)
                                        <tr class="line-product">
                                            ...
                                            <td>
                                                <input readonly type="text" name="produto_nome[]"
                                                    class="pdv-item-name" value="{{ $product->produto->nome }}">
                                            </td>
                                            <td>
                                                <div class="pdv-qty-group">
                                                    <button class="pdv-qty-btn pdv-qty-btn-minus" id="btn-subtrai"
                                                        type="button">-</button>
                                                    <input readonly type="tel" name="quantidade[]"
                                            ...
                                            <td>
                                                <input readonly type="tel" name="valor_unitario[]"
                                                    class="pdv-item-value"
                                        ...
                                        <div class="row g-1">
                                            <div class="col-4">
                                                <button type="button" class="btn pdv-action-btn btn-outline-info w-100"
                                                    ...
                                                    <i class="ri-list-check-3"></i> Pag. Multi <span class="pdv-shortcut pdv-shortcut-sm">F4</span>
                                                </button>
                                            </div>
                                            <div class="col-4">
                                                <button type="button" class="btn pdv-action-btn btn-outline-primary w-100"
                                                    ...
                                                    title="Observação"><i
                                                        class="ri-file-edit-fill"></i> Observ.
                                                </button>
                                            </div>
                                            <div class="col-4">
                                            ...
                                            <div class="col-6">
                                                <button type="submit" disabled class="pdv-btn-finalizar"
                                                    id="salvar_pre_venda">

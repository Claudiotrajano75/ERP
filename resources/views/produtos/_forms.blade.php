...
<style>
    ...
    .modulo-section-card .card-header .form-check-input:checked {
        background-color: #302b63;
        border-color: #302b63;
    }
    .modulo-section-card .card-body {
        padding: 20px;
        background: #fff;
    }
    .modulo-dynamic-table {
        border-radius: 10px;
        overflow: hidden;
        border: 1px solid #eef0f5;
    }
    .modulo-dynamic-table thead th {
    ...
    .modulo-dynamic-table tbody td {
        padding: 10px 14px;
        vertical-align: middle;
        border-bottom: 1px solid #f0f2f8;
    }
    .modulo-dynamic-table tbody tr:last-child td {
        border-bottom: none;
    }
    .modulo-image-upload {
    ...
    .modulo-image-upload:hover {
        border-color: #302b63;
        background: #f5f6fe;
    }
    .modulo-image-upload .preview {
        position: relative;
        display: inline-block;
        margin-bottom: 12px;
    }
    .modulo-image-upload .preview img {
        width: 120px;
        height: 120px;
        object-fit: cover;
        border-radius: 12px;
    ...
    .modulo-image-upload .preview #btn-remove-imagem {
        position: absolute;
        top: -8px;
        right: -8px;
        width: 24px;
    ...
    .modulo-image-upload input[type="file"] {
        font-size: 12px;
        color: #5a5a7a;
    }
    .spinner {
...
<div id="basicwizard">
    <ul class="nav nav-pills nav-justified modulo-wizard form-wizard-header mb-4 m-2">
        <li class="nav-item">
            <a href="#tab-identificacao" data-bs-toggle="tab" data-toggle="tab" class="nav-link rounded-0 py-2 px-3 active">
                <i class="ri-product-hunt-fill align-middle me-1"></i>
                <span class="d-none d-sm-inline">Identificação</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="#tab-fiscal" data-bs-toggle="tab" data-toggle="tab" class="nav-link rounded-0 py-2 px-3">
                <i class="ri-file-code-line align-middle me-1"></i>
                <span class="d-none d-sm-inline tab-fiscal">Fiscal</span>
            </a>
        </li>
        <li class="nav-item">
            <a href="#tab-outros" data-bs-toggle="tab" data-toggle="tab" class="nav-link rounded-0 py-2 px-3">
    ...
    <div class="tab-content b-0 mb-0">
        <div class="tab-pane show active" id="tab-identificacao">
            <div class="row g-2">
                ...
                <div class="col-12 div-variavel d-none">
                    <div class="modulo-dynamic-table">
                        <table class="table table-dynamic mb-0">
                            <thead>
                                <tr>
                                    <th style="background:#302b63;color:#fff;font-weight:700;font-size:11px;text-transform:uppercase;letter-spacing:0.3px;padding:10px 14px;border-bottom:2px solid #1a1a2e;">Variação</th>
                                    <th style="background:#302b63;color:#fff;font-weight:700;font-size:11px;text-transform:uppercase;letter-spacing:0.3px;padding:10px 14px;border-bottom:2px solid #1a1a2e;">Valores da variação</th>
                                </tr>
                            </thead>
                                <tr>
                                    <th>Variação</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="row">
                                            <table class="table table-dynamic table-variacao mb-0">
                                                <thead>
                                                    <tr>
                                                        <th style="background:#e8f5e9;color:#2e7d32;font-weight:700;font-size:11px;text-transform:uppercase;letter-spacing:0.3px;padding:10px 14px;border-bottom:2px solid #c8e6c9;">Descrição</th>
                                                        <th style="background:#e8f5e9;color:#2e7d32;font-weight:700;font-size:11px;text-transform:uppercase;letter-spacing:0.3px;padding:10px 14px;border-bottom:2px solid #c8e6c9;">Valor</th>
                                                        <th style="background:#e8f5e9;color:#2e7d32;font-weight:700;font-size:11px;text-transform:uppercase;letter-spacing:0.3px;padding:10px 14px;border-bottom:2px solid #c8e6c9;">Cód. Barras</th>
                                                        <th style="background:#e8f5e9;color:#2e7d32;font-weight:700;font-size:11px;text-transform:uppercase;letter-spacing:0.3px;padding:10px 14px;border-bottom:2px solid #c8e6c9;">Referência</th>
                                                        <th style="background:#e8f5e9;color:#2e7d32;font-weight:700;font-size:11px;text-transform:uppercase;letter-spacing:0.3px;padding:10px 14px;border-bottom:2px solid #c8e6c9;">Imagem</th>
                                                        <th style="background:#e8f5e9;color:#2e7d32;font-weight:700;font-size:11px;text-transform:uppercase;letter-spacing:0.3px;padding:10px 14px;border-bottom:2px solid #c8e6c9;"></th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    @isset($item)
                ...
                <div class="col-12 div-combo d-none">

                    <div class="row m-2">
                        <div class="col-md-3"></div>
                        <div class="col-md-6 col-12">
                            <select class="select2 form-control" style="width: 100%" id="inp-produto_combo_id"></select>
                        </div>
                    </div>
                    <div class="modulo-dynamic-table">
                        <table class="table table-dynamic table-combo mb-0">
                            <thead>
                                <tr>
                                    <th style="background:#302b63;color:#fff;font-weight:700;font-size:11px;text-transform:uppercase;letter-spacing:0.3px;padding:10px 14px;border-bottom:2px solid #1a1a2e;">Produto</th>
                                    <th style="background:#302b63;color:#fff;font-weight:700;font-size:11px;text-transform:uppercase;letter-spacing:0.3px;padding:10px 14px;border-bottom:2px solid #1a1a2e;">Quantidade</th>
                                    <th style="background:#302b63;color:#fff;font-weight:700;font-size:11px;text-transform:uppercase;letter-spacing:0.3px;padding:10px 14px;border-bottom:2px solid #1a1a2e;">Valor Compra</th>
                                    <th style="background:#302b63;color:#fff;font-weight:700;font-size:11px;text-transform:uppercase;letter-spacing:0.3px;padding:10px 14px;border-bottom:2px solid #1a1a2e;">Subtotal</th>
                                    <th style="background:#302b63;color:#fff;font-weight:700;font-size:11px;text-transform:uppercase;letter-spacing:0.3px;padding:10px 14px;border-bottom:2px solid #1a1a2e;">Ação</th>
                                </tr>
                            </thead>
                            <tbody>
                                @isset($item)
                ...
                <div class="col-md-3 mt-3">
                    <div class="modulo-image-upload">
                        <div class="preview">
                            <button type="button" id="btn-remove-imagem" class="btn btn-danger" style="position:absolute;top:-8px;right:-8px;width:24px;height:24px;border-radius:50%;padding:0;display:flex;align-items:center;justify-content:center;font-size:12px;border:none;">×</button>
                            @isset($item)
                            <img id="file-ip-1-preview" src="{{ $item->img }}" style="width:120px;height:120px;object-fit:cover;border-radius:12px;border:1px solid #eef0f5;">
                            @else
                            <img id="file-ip-1-preview" src="/imgs/no-image.png" style="width:120px;height:120px;object-fit:cover;border-radius:12px;border:1px solid #eef0f5;">
                            @endif
                        </div>
                        <label for="file-ip-1">Imagem do Produto</label>
                        @isset($item)
                        <div class="mb-2">
                            <a class="btn btn-outline-danger btn-sm" href="{{ route('produtos.remove-image', [$item->id])}}">
                                <i class="ri-close-line align-middle me-1"></i> Remover imagem
                            </a>
                        </div>
                        @endif
                        ...
                        <div class="mt-2">
                            <small class="text-muted fs-11 d-block">
                                <i class="ri-google-line align-middle me-1"></i>
                                Se nenhuma imagem for enviada ao salvar, o sistema buscará automaticamente.
                            </small>
                        </div>
                    </div>
                </div>
    ...
    <div class="tab-content b-0 mb-0">
        <div class="tab-pane" id="tab-outros">
            <div class="row g-2">
                <div class="row">
                    <div class="col-12">
                        <div class="card modulo-section-card border-0 shadow-sm">
                            <div class="card-header">
                                <h4 class="d-flex align-items-center gap-2">
                                    <i class="ri-oil-line" style="color:#5c6bc0;"></i>
                            ...
                            <div class="card-body div-petroleo d-none" style="margin-top: 0;">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card modulo-section-card border-0 shadow-sm">
                            <div class="card-header">
                                <h4 class="d-flex align-items-center gap-2">
                                    <i class="ri-restaurant-2-line" style="color:#e53935;"></i>
                                    @isset($cardapio)
                                    @if($cardapio == 1)
                                    <input type="hidden" name="redirect_cardapio" value="1">
                                    @endif
                                    @endif
                                    <div class="form-check form-switch form-checkbox-danger mb-0">
                            ...
                            <div class="card-body div-cardapio d-none" style="margin-top: 0;">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card modulo-section-card border-0 shadow-sm">
                            <div class="card-header">
                                <h4 class="d-flex align-items-center gap-2">
                                    <i class="ri-truck-line" style="color:#43a047;"></i>
                                    @isset($delivery)
                                    @if($delivery == 1)
                                    <input type="hidden" name="redirect_delivery" value="1">
                                    @endif
                                    @endif
                                    <div class="form-check form-switch form-checkbox-success mb-0">
                            ...
                            <div class="card-body div-delivery d-none" style="margin-top: 0;">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card modulo-section-card border-0 shadow-sm">
                            <div class="card-header">
                                <h4 class="d-flex align-items-center gap-2">
                                    <i class="ri-cloud-line" style="color:#039be5;"></i>
                                    @isset($nuvemshop)
                                    @if($nuvemshop == 1)
                                    <input type="hidden" name="redirect_nuvemshop" value="1">
                                    @endif
                                    @endif
                                    <div class="form-check form-switch form-checkbox-info mb-0">
                            ...
                            <div class="card-body div-nuvemshop d-none" style="margin-top: 0;">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card modulo-section-card border-0 shadow-sm">
                            <div class="card-header">
                                <h4 class="d-flex align-items-center gap-2">
                                    <i class="ri-shopping-bag-3-line" style="color:#fb8c00;"></i>
                                    @isset($mercadolivre)
                                    @if($mercadolivre == 1)
                                    <input type="hidden" name="redirect_mercadolivre" value="1">
                                    @endif
                                    @endif
                                    <div class="form-check form-switch form-checkbox-warning mb-0">
                            ...
                            <div class="card-body div-mercadolivre d-none" style="margin-top: 0;">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card modulo-section-card border-0 shadow-sm">
                            <div class="card-header">
                                <h4 class="d-flex align-items-center gap-2">
                                    <i class="ri-global-line" style="color:#039be5;"></i>
                                    @isset($ecommerce)
                                    @if($ecommerce == 1)
                            ...
                            <div class="card-body div-ecommerce d-none" style="margin-top: 0;">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card modulo-section-card border-0 shadow-sm">
                            <div class="card-header">
                                <h4 class="d-flex align-items-center gap-2">
                                    <i class="ri-calendar-check-line" style="color:#e53935;"></i>
                                    @isset($reserva)
                                    @if($reserva == 1)
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card modulo-section-card border-0 shadow-sm">
                            <div class="card-header">
                                <h4 class="d-flex align-items-center gap-2">
                                    <i class="ri-wordpress-line" style="color:#455a64;"></i>
                                    @isset($woocommerce)
                                    @if($woocommerce == 1)
                                    <input type="hidden" name="redirect_woocommerce" value="1">
                                    @endif
                                    @endif
                                    <div class="form-check form-switch form-checkbox-dark mb-0">
                            ...
                            <div class="card-body div-woocommerce d-none" style="margin-top: 0;">
...
<script>
    // Busca imagem automaticamente após carregar a página (apenas se não tiver imagem)
    document.addEventListener('DOMContentLoaded', function() {
        const preview = document.getElementById('file-ip-1-preview');
        if (preview && preview.src && preview.src.includes('no-image')) {
            // Preview será atualizado quando salvar
        }
    });
</script>
@endif
...
<script>
    $(document).on('click', '#btn-buscar-unsplash', function() {
        ...
        btn.prop('disabled', true).html('<i class="ri-loader-2-line align-middle me-1 spinner"></i> Buscando...');
        
        $.get(path_url + 'produtos-buscar-imagem-unsplash/' + productId[1])
        .done(function(res) {
            if (res.success) {

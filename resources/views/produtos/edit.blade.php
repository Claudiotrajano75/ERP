...
<style>
    ...
    .modulo-form-card .input-group .form-control {
        ...
        <div class="col-lg-12">
            <div class="card border-0 shadow-sm modulo-form-card">
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            ...
                            <p class="text-muted mb-0 modulo-subtitle fs-13">
                                Altere informações de venda, tributos, estoque e integrações do produto.
                            </p>
                        </div>
                        <div>
                ...
                <div class="card-body p-4">
                    ...
                    @include('produtos._forms', ['not_submit' => true])
                    ...
                    <div class="modulo-actions">
                        <div class="d-flex gap-2 justify-content-end">
                            ...
                            <button type="submit" class="btn btn-primary px-4" id="btn-store">
                                <i class="ri-save-line align-middle me-1"></i> Atualizar Produto
                            </button>
                        </div>
                    </div>

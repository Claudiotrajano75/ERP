<div class="row g-3 text-dark">
                ...
                <table class="table table-centered table-hover align-middle mb-0 text-dark">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="fw-semibold text-dark">{{ $item->contaReceber && $item->contaReceber->cliente ? $item->contaReceber->cliente->info : '--' }}</td>
                            ...
                            <td>
                                <span class="badge bg-light text-dark border px-2 py-1 fs-11">
                                    {{ $item->contaBoleto ? $item->contaBoleto->banco : '--' }}
                                </span>
                            </td>
                        </tr>
                        @empty
    ...
    <div class="col-12 mt-4">
        ...
        <div class="d-flex align-items-center justify-content-end gap-2">
            <a href="{{ route('remessa-boleto.index') }}" class="dash-btn dash-btn-light">Cancelar</a>
            <button type="submit" class="dash-btn dash-btn-primary" id="btn-store">
                <i class="ri-file-zip-line"></i> Gerar Arquivo de Remessa
            </button>
        </div>
    </div>
</div>

                ...
                <div class="modulo-glass-filter p-3 mb-4">
                    ...
                    <div class="row g-2 align-items-end">
                        ...
                        <div class="col-md-3 col-12">
                            {!!Form::select('conta_boleto_id', 'Conta', ['' => 'Selecione'] + $contasBoleto->pluck('info', 'id')->all())->attrs(['class' => 'form-select form-select-sm'])!!}
                        </div>
                        <div class="col-md-3 col-12 ms-auto">
                            <div class="d-flex gap-2">
                                ...
                                <a class="btn btn-outline-secondary btn-sm px-3" href="{{ route('remessa-boleto.index') }}"><i class="ri-eraser-line me-1"></i> Limpar</a>
                            </div>
                        </div>
                    </div>
                    {!!Form::close()!!}

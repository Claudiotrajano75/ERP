@extends('layouts.app', ['title' => 'Check-in #' . $item->numero_sequencial])
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            <h4 class="mb-1 modulo-title d-flex align-items-center gap-2">
                                ...
                                Check-in <span class="ms-1 fw-bold">#{{ $item->numero_sequencial }}</span>
                            </h4>
                            <p class="mb-0 modulo-subtitle fs-13">
                                Preencha as informações para finalizar o check-in.
                            </p>
                        </div>

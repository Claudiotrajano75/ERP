                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        <h4 class="mb-1 modulo-title d-flex align-items-center gap-2">
                            ...
                            Atribuições (Papéis de Acesso)
                        </h4>
                        <p class="text-muted mb-0 modulo-subtitle fs-13">Gerencie os papéis e permissões de acesso ao sistema.</p>
                    </div>
                    <div>
                        <a href="{{ route('roles.create') }}" class="btn btn-light btn-sm px-3 text-dark">
                            <i class="ri-add-circle-line align-middle me-1"></i> Nova Atribuição
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row g-2 align-items-end">
                        ...
                        <div class="col-md-6 col-12 ms-auto">
                            <div class="d-flex gap-2">
                                ...
                                <a class="btn btn-danger btn-sm px-3" href="{{ route('roles.index') }}"><i class="ri-eraser-line me-1"></i> Limpar</a>
                            </div>
                        </div>
                    </div>
                    {!!Form::close()!!}
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-end">
                                        ...
                                        <form action="{{ route('roles.destroy', $item->id) }}" method="post" id="form-{{$item->id}}" class="m-0">
                                            @method('delete')
                                            @csrf
                                            <div class="modulo-action-group">
                                                <a class="btn btn-warning btn-sm text-white" href="{{ route('roles.edit', [$item->id]) }}" title="Editar">

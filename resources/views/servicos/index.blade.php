                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        ...
                        <p class="text-muted mb-0 modulo-subtitle fs-13">
                            Gerencie a tabela de serviços prestados, valores de cobrança, durações e comissões.
                        </p>
                    </div>
                    <div class="d-flex gap-2 flex-wrap">
                        ...
                        @can('servico_create')
                        <a href="{{ route('servicos.create') }}" class="dash-btn dash-btn-primary">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-12 col-md-3">
                        <div class="stat-card stat-indigo">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    <div class="st-label">Total de Serviços</div>
                                    <div class="st-value">{{ $stats['total'] ?? $data->total() }}</div>
                                    <div class="st-sub">cadastros no sistema</div>
                                </div>
                                <div class="st-icon"><i class="ri-briefcase-4-line"></i></div>
                            </div>
                        </div>
                    </div>
                    <div class="col-12 col-md-3">
                        <div class="stat-card stat-green">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    <div class="st-label">Serviços Ativos</div>
                                    <div class="st-value">{{ $stats['ativos'] ?? 0 }}</div>
                                    <div class="st-sub">disponíveis para venda</div>
                                </div>
                    ...
                    <div class="col-12 col-md-3">
                        <div class="stat-card stat-amber">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    <div class="st-label">Serviços Inativos</div>
                                    <div class="st-value">{{ $stats['inativos'] ?? 0 }}</div>
                                    <div class="st-sub">pausados / desativados</div>
                                </div>
                    ...
                    <div class="col-12 col-md-3">
                        <div class="stat-card stat-purple">
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    <div class="st-label">Marketplace / Delivery</div>
                                    <div class="st-value">{{ $stats['marketplace'] ?? 0 }}</div>
                                    <div class="st-sub">visíveis no app/loja</div>
                                </div>
                                <div class="st-icon"><i class="ri-store-line"></i></div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <form method="get" action="{{ route('servicos.index') }}">
                        <div class="row g-3 align-items-end">
                            <div class="col-md-5 col-12">
                                ...
                                <input type="text" name="nome" value="{{ request('nome') }}" class="form-control" placeholder="Digite o nome do serviço...">
                            </div>
                            ...
                            <div class="col-md-2 col-6 d-flex gap-2">
                                ...
                                <a class="dash-btn dash-btn-light px-3" href="{{ route('servicos.index') }}" title="Limpar Filtros">
                        ...
                        <table class="table table-centered table-hover align-middle mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @endcan
                                    <td>
                                        <img class="rounded-circle border bg-light shadow-sm" src="{{ $item->img }}"
                                             style="width:38px;height:38px;object-fit:cover;">
                                    </td>
                                    <td>
                                        <span class="fw-bold text-muted">#{{ $item->numero_sequencial }}</span>
                                    </td>
                                    <td>
                                        <div class="fw-semibold" style="color:#1f2937;">{{ $item->nome }}</div>
                                        @if($item->categoria)
                                        <div class="fs-12" style="color:#94a3b8;"><i class="ri-folder-line me-1"></i>{{ $item->categoria->nome }}</div>
                                        @endif
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <span class="badge bg-light text-dark border px-2 py-1 fs-11">
                                            <i class="ri-time-line me-1 text-muted"></i>{{ $item->tempo_servico }} {{ $item->unidade_cobranca }}
                                        </span>
                                    </td>
                                    <td>
                                        @if($item->status)
                                    ...
                                    <td class="text-end">
                                        <form action="{{ route('servicos.destroy', $item->id) }}" method="post"
                                            ...
                                            @csrf
                                            <div class="act-group">
                                                <a class="act-btn act-view" href="{{ route('servicos.show', [$item->id]) }}" title="Ver Detalhes">
                                                    <i class="ri-eye-line"></i>
                                                </a>
                                                @can('servico_edit')
                                                <a class="act-btn act-edit" href="{{ route('servicos.edit', [$item->id]) }}" title="Editar Serviço">

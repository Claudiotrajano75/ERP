            ...
            <div class="card-body p-4">
                ...
                <div class="modulo-glass-filter p-3 mb-4">
                    ...
                    <div class="row g-2 align-items-end">
                        ...
                        <div class="col-md-3 col-6">
                            {!!Form::select('status', 'Status', ['' => 'Todos', '1' => 'Ativos', '0' => 'Inativos'])->attrs(['class' => 'form-select form-select-sm'])!!}
                        </div>
                        <div class="col-md-3 col-12 ms-auto">
                            <div class="d-flex gap-2">
                                ...
                                <a class="btn btn-danger btn-sm px-3" href="{{ route('servicos.index') }}">

@extends('layouts.app', ['title' => 'Editar Tamanho de Pizza'])
        ...
        <div class="card-header modulo-header-gradient py-3 px-4">
            <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                <h4 class="mb-0 modulo-title d-flex align-items-center gap-2">
                    <i class="ri-edit-line"></i> Editar Tamanho de Pizza
                </h4>
                <a href="{{ route('tamanhos-pizza.index') }}" class="btn btn-light btn-sm px-3 text-dark d-flex align-items-center gap-1">

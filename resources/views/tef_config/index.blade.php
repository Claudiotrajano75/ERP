                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        ...
                        <p class="text-muted mb-0 modulo-subtitle fs-13">
                            Gerencie as configurações de TEF (Transferência Eletrônica de Fundos) para integração com máquinas de cartão.
                        </p>
                    </div>
                    <div class="d-inline-flex gap-2">
                        <a href="{{ route('tef-config.create') }}" class="btn btn-light btn-sm px-3 text-dark">
                    ...
                    <div class="table-responsive">
                        <table class="table table-centered table-hover align-middle mb-0 text-dark">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>
                                        <span class="fw-semibold text-dark d-block">{{ $item->usuario->name }}</span>
                                    </td>
                                    <td>{{ $item->cnpj }}</td>
                                    <td><span class="fw-bold">{{ $item->pdv }}</span></td>
                                    <td>
                                        @if($item->status)

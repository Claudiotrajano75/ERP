@extends('layouts.app', ['title' => 'Nova Transferência de Estoque'])
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            <h4 class="mb-1 modulo-title d-flex align-items-center gap-2">
                                ...
                                Registrar Nova Transferência de Estoque
                            </h4>
                            <p class="text-muted mb-0 modulo-subtitle fs-13">
                                Mova produtos fisicamente de uma localização de estoque para outra registrando as quantidades.
                            </p>
                        </div>
                        <div>
                            <a href="{{ route('transferencia-estoque.index') }}" class="btn btn-light btn-sm px-3 text-dark">

<div class="row g-3 text-dark">
    ...
    <div class="col-12">
        <h5 class="text-dark border-bottom pb-2 mb-3"><i class="ri-ship-2-line text-primary me-2 align-middle fs-18"></i> 1. Identificação da Transportadora</h5>
        <div class="row g-3">
            <div class="col-md-3 col-12">
                {!!Form::tel('cpf_cnpj', 'CPF/CNPJ')->attrs(['class' => 'form-control cpf_cnpj', 'id' => 'inp-cpf_cnpj'])->required()!!}
            ...
            <div class="col-md-3 col-6">
                {!!Form::tel('ie', 'Inscrição Estadual (IE)')->attrs(['class' => 'form-control ie', 'id' => 'inp-ie'])!!}
            </div>

            <div class="col-md-3 col-6">
                {!!Form::tel('antt', 'Registro ANTT')->attrs(['class' => 'form-control', 'id' => 'inp-antt'])!!}
            </div>

            <div class="col-md-3 col-6">
                {!!Form::tel('telefone', 'Telefone')->attrs(['class' => 'form-control fone', 'id' => 'inp-telefone'])->required()!!}
            </div>

            <div class="col-md-3 col-6">
                {!!Form::text('email', 'E-mail')->attrs(['class' => 'form-control', 'id' => 'inp-email'])!!}
            </div>
        </div>
    </div>
    ...
    <div class="col-12 mt-4">
        <h5 class="text-dark border-bottom pb-2 mb-3"><i class="ri-map-pin-line text-primary me-2 align-middle fs-18"></i> 2. Endereço da Sede</h5>
        <div class="row g-3">
            <div class="col-md-4 col-12">
                @isset($item)
            ...
            <div class="col-md-3 col-6">
                {!!Form::tel('cep', 'CEP')->attrs(['class' => 'form-control cep', 'id' => 'inp-cep'])->required()!!}
            </div>
    ...
    <div class="col-12 mt-4">
        ...
        <div class="d-flex align-items-center justify-content-end gap-2">
            <a href="{{ route('transportadoras.index') }}" class="btn btn-outline-secondary px-4">
                <i class="ri-close-line align-middle me-1"></i> Cancelar
            </a>
            <button type="submit" class="btn {{ $formType === 'edit' ? 'btn-primary' : 'btn-success' }} px-4" id="btn-store">
                <i class="ri-save-line align-middle me-1"></i> {{ $formType === 'edit' ? 'Salvar Alterações' : 'Salvar Transportadora' }}
            </button>
        </div>
    </div>

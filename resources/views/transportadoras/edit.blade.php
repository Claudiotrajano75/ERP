                ...
                <div class="card-header modulo-header-gradient py-3 px-4">
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            ...
                            <p class="text-muted mb-0 modulo-subtitle fs-13">Altere a identificação cadastral, registro ANTT ou localidade da transportadora.</p>
                        </div>
                        <div>
                            <a href="{{ route('transportadoras.index') }}" class="btn btn-light btn-sm px-3 text-dark">

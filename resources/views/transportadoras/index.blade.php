                ...
                <div class="modulo-glass-filter-premium">
                    ...
                    <div class="row g-3">
                        <div class="col-md-5 col-12">
                            <label class="form-label"><i class="ri-ship-2-line"></i> Nome / Razão Social</label>
                            {!!Form::text('razao_social', '')->attrs(['class' => 'form-control', 'placeholder' => 'Digite a razão da transportadora...'])!!}
                        </div>
                        ...
                        <div class="col-md-3 col-12 ms-auto d-flex align-items-end">
                            <div class="d-flex gap-2 w-100">
                                ...
                                <a class="btn btn-limpar px-3" href="{{ route('transportadoras.index') }}" title="Limpar Filtros">

@extends('layouts.app', ['title' => 'Nova Unidade de Medida'])
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            ...
                            <p class="text-muted mb-0 modulo-subtitle fs-13">
                                Configure uma nova unidade para fracionar e comercializar seus produtos.
                            </p>
                        </div>
                        <div>
                            <a href="{{ route('unidades-medida.index') }}" class="btn btn-light btn-sm px-3 text-dark">

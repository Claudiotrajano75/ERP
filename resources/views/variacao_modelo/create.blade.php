...
.modulo-dynamic-table thead th { background: #f8f9fc; color: #5a5a7a; font-weight: 700; font-size: 11px; text-transform: uppercase; letter-spacing: 0.4px; padding: 12px 14px; border-bottom: 2px solid #e8eaf6; }
.modulo-dynamic-table tbody td { padding: 10px 14px; vertical-align: middle; border-bottom: 1px solid #f0f2f8; }
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            <h4 class="mb-1 modulo-title d-flex align-items-center gap-2">
                                ...
                                Cadastrar Novo Modelo de Variação
                            </h4>
                            <p class="text-muted mb-0 modulo-subtitle fs-13">
                                Configure grades de atributos e as opções que comporão as variações de seus produtos.
                            </p>
                        </div>
                        <div>

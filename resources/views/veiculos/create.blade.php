            ...
            <div class="card-header modulo-header-gradient py-3 px-4">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        ...
                        <p class="text-muted mb-0 modulo-subtitle fs-13">Preencha os dados abaixo para cadastrar um novo veículo no sistema.</p>
                    </div>
                    <div class="d-inline-flex align-items-center gap-2">
                        <a href="{{ route('veiculos.index') }}" class="btn btn-light btn-sm px-3 text-dark">

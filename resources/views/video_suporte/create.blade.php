@extends('layouts.app', ['title' => 'Novo Vídeo de Suporte'])
                    ...
                    <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                        <div>
                            <h4 class="mb-0 modulo-title">
                                ...
                                Novo Vídeo de Suporte
                            </h4>
                            <p class="modulo-subtitle">
                                Cadastre um link de tutorial em vídeo para vincular a uma tela do sistema.
                            </p>
                        </div>
                        <div>
                            <a href="{{ route('video-suporte.index') }}" class="btn btn-light btn-sm text-dark">

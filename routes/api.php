...
Route::group(['prefix' => 'admin/dashboard'], function () {
    Route::get('/grafico-novas-empresas', '\App\Http\Controllers\Admin\DashboardController@graficoNovasEmpresas');
    Route::get('/grafico-faturamento-planos', '\App\Http\Controllers\Admin\DashboardController@graficoFaturamentoPlanos');
});
...
Route::group(['prefix' => 'graficos'], function () {
    ...
    Route::get('/dados-cards-avancado', 'GraficoController@dadosCardsAvancado');
});
...
Route::middleware(['validaApiToken'])->group(function () {
    Route::group(['prefix' => 'v1'], function () {
        ...
        Route::group(['prefix' => 'produtos-imagens'], function () {
            Route::get('/{id}/download-zip', '\App\Http\Controllers\ProdutoImagemDownloadController@apiDownloadProdutoZip');
            Route::post('/download-lote', '\App\Http\Controllers\ProdutoImagemDownloadController@apiDownloadLote');
            Route::get('/{id}/listar', '\App\Http\Controllers\ProdutoImagemDownloadController@apiListarImagens');
        });

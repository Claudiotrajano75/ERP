...
Route::middleware(['authh', 'validaEmpresa'])->group(function () {
    ...
    Route::middleware(['verificaEmpresa', 'validaPlano'])->group(function () {
        ...
        // Download de imagens
        Route::get('/produto-download-zip/{id}', 'ProdutoImagemDownloadController@downloadProdutoZip')->name('produtos.download-zip');
        Route::get('/produto-download-imagem-principal/{id}', 'ProdutoImagemDownloadController@downloadImagemPrincipal')->name('produtos.download-imagem-principal');
        Route::get('/produto-download-imagem-galeria/{id}', 'ProdutoImagemDownloadController@downloadImagemGaleria')->name('produtos.download-imagem-galeria');
        Route::post('/produto-download-selecionados', 'ProdutoImagemDownloadController@downloadSelecionadosZip')->name('produtos.download-selecionados');
        ...
        Route::group(['prefix' => 'pdv/draft'], function () {
            Route::post('/save', 'PdvDraftController@save')->name('pdv.draft.save');
            Route::get('/current', 'PdvDraftController@current')->name('pdv.draft.current');
            Route::delete('/clear', 'PdvDraftController@clear')->name('pdv.draft.clear');
        });
        ...
        // Rota para Migração de Legado
        Route::get('/migracao', 'MigracaoController@index')->name('migracao.index');
        Route::post('/migracao', 'MigracaoController@store')->name('migracao.store');

        // Rota NCM Finder
        Route::get('/migracao/ncm-finder', 'NcmFinderController@index')->name('migracao.ncm_finder');
        Route::get('/migracao/ncm-finder/{id}', 'NcmFinderController@find')->name('migracao.ncm_find');

        // Rota Correção Encoding
        Route::get('/migracao/fix-encoding', 'MigracaoController@fixEncoding');
        Route::get('/migracao/reset-products', 'MigracaoController@resetProducts');
